...
// WSDL     : D:\Projeler\DELPHI\Diyaliz\Dializ2007_M3_\BirlabService.wsdl
//  >Import : D:\Projeler\DELPHI\Diyaliz\Dializ2007_M3_\BirlabService.wsdl>0
// Encoding : utf-8
// Version  : 1.0
// (10.10.2019 12:53:09 - - $Rev: 45757 $)
// ************************************************************************ //

unit HGMBILISIMServiceBirlab;
...
const
  defWSDL = 'D:\Projeler\DELPHI\Diyaliz\Dializ2007_M3_\BirlabService.wsdl';
...
initialization
  ...
  { ServiceSoap.TcdenSonucSorgula }
  InvRegistry.RegisterMethodInfo(TypeInfo(ServiceSoap), 'TcdenSonucSorgula', '',
                                 '[ReturnName="TcdenSonucSorgulaResult"]', IS_OPTN);
  { ServiceSoap.islemNodanSonucSorgula }
  InvRegistry.RegisterMethodInfo(TypeInfo(ServiceSoap), 'islemNodanSonucSorgula', '',
                                 '[ReturnName="islemNodanSonucSorgulaResult"]', IS_OPTN);
  { ServiceSoap.HastaListesi }
  InvRegistry.RegisterMethodInfo(TypeInfo(ServiceSoap), 'HastaListesi', '',
  ...
  RemClassRegistry.RegisterExternalPropName(TypeInfo(SorguCevap), 'testler', '[ArrayItemName="Test"]');
  ...
  RemClassRegistry.RegisterExternalPropName(TypeInfo(HastaListesiCevap), 'Hst', '[ArrayItemName="Hastalar"]');
