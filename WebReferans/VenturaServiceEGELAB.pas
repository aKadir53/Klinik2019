...
// WSDL     : http://213.14.77.58/AlisWS/?wsdl
//  >Import : http://213.14.77.58/AlisWS/?wsdl>0
// Encoding : utf-8
// Version  : 1.0
// (09.10.2019 16:28:45 - - $Rev: 45757 $)
// ************************************************************************ //

unit VenturaServiceEGELAB;
...
type
  ...
  KonsultasyonTalepSonuc = class;               { "http://tempuri.org/"[GblCplx] }
  ...
  DisLabUrunIstemSonuc = class;                 { "http://tempuri.org/"[GblCplx] }
  DisLabUrunIstem      = class;                 { "http://tempuri.org/"[GblCplx] }
  SonucDosyaResult     = class;                 { "http://tempuri.org/"[GblCplx] }
  MethodSonuc          = class;                 { "http://tempuri.org/"[GblCplx] }
  SonucDosya           = class;                 { "http://tempuri.org/"[GblCplx] }
  ...
  SonucReq             = class;                 { "http://tempuri.org/"[GblCplx] }
  Sonuc                = class;                 { "http://tempuri.org/"[GblCplx] }
  KonsultasyonSorguSonuc = class;               { "http://tempuri.org/"[GblCplx] }
  Konsultasyon         = class;                 { "http://tempuri.org/"[GblCplx] }
  SonucRes             = class;                 { "http://tempuri.org/"[GblCplx] }
  ...
  SonucYazDur          = class;                 { "http://tempuri.org/"[GblCplx] }
  ...
  // ************************************************************************ //
  // XML       : KonsultasyonTalepSonuc, global, <complexType>
  // Namespace : http://tempuri.org/
  // ************************************************************************ //
  KonsultasyonTalepSonuc = class(TRemotable)
  private
    FislemSonuc: IslemSonuc;
    FislemSonuc_Specified: boolean;
    FKonsultasyonID: Integer;
  ...
  published
    ...
    property KonsultasyonID: Integer     read FKonsultasyonID write FKonsultasyonID;
  end;
  ...
  private
    ...
    FSONUC_DOSYASI_VAR: string;
    FSONUC_DOSYASI_VAR_Specified: boolean;
    procedure SetislemSonuc(Index: Integer; const AIslemSonuc: IslemSonuc);
    function  islemSonuc_Specified(Index: Integer): boolean;
    ...
    procedure SetSONUC_DOSYASI_VAR(Index: Integer; const Astring: string);
    function  SONUC_DOSYASI_VAR_Specified(Index: Integer): boolean;
  public
    destructor Destroy; override;
  published
    property islemSonuc:           IslemSonuc   Index (IS_OPTN) read FislemSonuc write SetislemSonuc stored islemSonuc_Specified;
    ...
    property SONUC_DOSYASI_VAR:    string       Index (IS_OPTN) read FSONUC_DOSYASI_VAR write SetSONUC_DOSYASI_VAR stored SONUC_DOSYASI_VAR_Specified;
  end;
  ...
  ArrayOfDisLabUrunIstem = array of DisLabUrunIstem;   { "http://tempuri.org/"[GblCplx] }


  // ************************************************************************ //
  // XML       : DisLabUrunIstemSonuc, global, <complexType>
  // Namespace : http://tempuri.org/
  // ************************************************************************ //
  DisLabUrunIstemSonuc = class(TRemotable)
  private
    FmethodSonuc: MethodSonuc;
    FmethodSonuc_Specified: boolean;
    FDisLabUrunIstemleri: ArrayOfDisLabUrunIstem;
    FDisLabUrunIstemleri_Specified: boolean;
    procedure SetmethodSonuc(Index: Integer; const AMethodSonuc: MethodSonuc);
    function  methodSonuc_Specified(Index: Integer): boolean;
    procedure SetDisLabUrunIstemleri(Index: Integer; const AArrayOfDisLabUrunIstem: ArrayOfDisLabUrunIstem);
    function  DisLabUrunIstemleri_Specified(Index: Integer): boolean;
  public
    destructor Destroy; override;
  published
    property methodSonuc:         MethodSonuc             Index (IS_OPTN) read FmethodSonuc write SetmethodSonuc stored methodSonuc_Specified;
    property DisLabUrunIstemleri: ArrayOfDisLabUrunIstem  Index (IS_OPTN) read FDisLabUrunIstemleri write SetDisLabUrunIstemleri stored DisLabUrunIstemleri_Specified;
  end;



  // ************************************************************************ //
  // XML       : DisLabUrunIstem, global, <complexType>
  // Namespace : http://tempuri.org/
  // ************************************************************************ //
  DisLabUrunIstem = class(TRemotable)
  private
    FISBT_UNITE_NO: string;
    FISBT_UNITE_NO_Specified: boolean;
    FISBT_BILESEN_KODU: string;
    FISBT_BILESEN_KODU_Specified: boolean;
    FKAN_GRUBU: string;
    FKAN_GRUBU_Specified: boolean;
    FSON_KULLANMA_TARIHI: TXSDateTime;
    FKAN_BILESENI: string;
    FKAN_BILESENI_Specified: boolean;
    FISLEM_DURUMU: string;
    FISLEM_DURUMU_Specified: boolean;
    FKAN_BILESENI_NO: Integer;
    FKAN_GRUBU_NO: Integer;
    FSTOK_DURUMU_NO: Integer;
    FBAGIS_TARIHI: TXSDateTime;
    FDISLAB_URUN_ISTEM_ID: Integer;
    procedure SetISBT_UNITE_NO(Index: Integer; const Astring: string);
    function  ISBT_UNITE_NO_Specified(Index: Integer): boolean;
    procedure SetISBT_BILESEN_KODU(Index: Integer; const Astring: string);
    function  ISBT_BILESEN_KODU_Specified(Index: Integer): boolean;
    procedure SetKAN_GRUBU(Index: Integer; const Astring: string);
    function  KAN_GRUBU_Specified(Index: Integer): boolean;
    procedure SetKAN_BILESENI(Index: Integer; const Astring: string);
    function  KAN_BILESENI_Specified(Index: Integer): boolean;
    procedure SetISLEM_DURUMU(Index: Integer; const Astring: string);
    function  ISLEM_DURUMU_Specified(Index: Integer): boolean;
  public
    destructor Destroy; override;
  published
    property ISBT_UNITE_NO:        string       Index (IS_OPTN) read FISBT_UNITE_NO write SetISBT_UNITE_NO stored ISBT_UNITE_NO_Specified;
    property ISBT_BILESEN_KODU:    string       Index (IS_OPTN) read FISBT_BILESEN_KODU write SetISBT_BILESEN_KODU stored ISBT_BILESEN_KODU_Specified;
    property KAN_GRUBU:            string       Index (IS_OPTN) read FKAN_GRUBU write SetKAN_GRUBU stored KAN_GRUBU_Specified;
    property SON_KULLANMA_TARIHI:  TXSDateTime  read FSON_KULLANMA_TARIHI write FSON_KULLANMA_TARIHI;
    property KAN_BILESENI:         string       Index (IS_OPTN) read FKAN_BILESENI write SetKAN_BILESENI stored KAN_BILESENI_Specified;
    property ISLEM_DURUMU:         string       Index (IS_OPTN) read FISLEM_DURUMU write SetISLEM_DURUMU stored ISLEM_DURUMU_Specified;
    property KAN_BILESENI_NO:      Integer      read FKAN_BILESENI_NO write FKAN_BILESENI_NO;
    property KAN_GRUBU_NO:         Integer      read FKAN_GRUBU_NO write FKAN_GRUBU_NO;
    property STOK_DURUMU_NO:       Integer      read FSTOK_DURUMU_NO write FSTOK_DURUMU_NO;
    property BAGIS_TARIHI:         TXSDateTime  read FBAGIS_TARIHI write FBAGIS_TARIHI;
    property DISLAB_URUN_ISTEM_ID: Integer      read FDISLAB_URUN_ISTEM_ID write FDISLAB_URUN_ISTEM_ID;
  end;

  ArrayOfSonucDosya = array of SonucDosya;      { "http://tempuri.org/"[GblCplx] }


  // ************************************************************************ //
  // XML       : SonucDosyaResult, global, <complexType>
  // Namespace : http://tempuri.org/
  // ************************************************************************ //
  SonucDosyaResult = class(TRemotable)
  private
    FislemSonuc: IslemSonuc;
    FislemSonuc_Specified: boolean;
    FDosyalar: ArrayOfSonucDosya;
    FDosyalar_Specified: boolean;
    procedure SetislemSonuc(Index: Integer; const AIslemSonuc: IslemSonuc);
    function  islemSonuc_Specified(Index: Integer): boolean;
    procedure SetDosyalar(Index: Integer; const AArrayOfSonucDosya: ArrayOfSonucDosya);
    function  Dosyalar_Specified(Index: Integer): boolean;
  public
    destructor Destroy; override;
  published
    property islemSonuc: IslemSonuc         Index (IS_OPTN) read FislemSonuc write SetislemSonuc stored islemSonuc_Specified;
    property Dosyalar:   ArrayOfSonucDosya  Index (IS_OPTN) read FDosyalar write SetDosyalar stored Dosyalar_Specified;
  end;



  // ************************************************************************ //
  // XML       : MethodSonuc, global, <complexType>
  // Namespace : http://tempuri.org/
  // ************************************************************************ //
  MethodSonuc = class(TRemotable)
  private
    FRes: Integer;
    FResultID: Integer;
    FHataMesaji: string;
  ...
  // ************************************************************************ //
  // XML       : SonucDosya, global, <complexType>
  // Namespace : http://tempuri.org/
  // ************************************************************************ //
  SonucDosya = class(TRemotable)
  private
    FORNEKNO: Integer;
    FSONUC_ID: Integer;
    FSONUC_DOSYA_ID: Integer;
    FTEST_ADI: string;
    FTEST_ADI_Specified: boolean;
    FFILE_EXTENSION: string;
    FFILE_EXTENSION_Specified: boolean;
    FFILE_ACIKLAMA: string;
    FFILE_ACIKLAMA_Specified: boolean;
    FFILE_BYTES: TByteDynArray;
    FFILE_BYTES_Specified: boolean;
    procedure SetTEST_ADI(Index: Integer; const Astring: string);
    function  TEST_ADI_Specified(Index: Integer): boolean;
    procedure SetFILE_EXTENSION(Index: Integer; const Astring: string);
    function  FILE_EXTENSION_Specified(Index: Integer): boolean;
    procedure SetFILE_ACIKLAMA(Index: Integer; const Astring: string);
    function  FILE_ACIKLAMA_Specified(Index: Integer): boolean;
    procedure SetFILE_BYTES(Index: Integer; const ATByteDynArray: TByteDynArray);
    function  FILE_BYTES_Specified(Index: Integer): boolean;
  published
    property ORNEKNO:        Integer        read FORNEKNO write FORNEKNO;
    property SONUC_ID:       Integer        read FSONUC_ID write FSONUC_ID;
    property SONUC_DOSYA_ID: Integer        read FSONUC_DOSYA_ID write FSONUC_DOSYA_ID;
    property TEST_ADI:       string         Index (IS_OPTN) read FTEST_ADI write SetTEST_ADI stored TEST_ADI_Specified;
    ...
    property FILE_ACIKLAMA:  string         Index (IS_OPTN) read FFILE_ACIKLAMA write SetFILE_ACIKLAMA stored FILE_ACIKLAMA_Specified;
    property FILE_BYTES:     TByteDynArray  Index (IS_OPTN) read FFILE_BYTES write SetFILE_BYTES stored FILE_BYTES_Specified;
  end;
  ...
  ArrayOfSonuc = array of Sonuc;                { "http://tempuri.org/"[GblCplx] }


  // ************************************************************************ //
  // XML       : SonucReq, global, <complexType>
  // Namespace : http://tempuri.org/
  // ************************************************************************ //
  SonucReq = class(TRemotable)
  private
    FVENUSER: string;
    FVENUSER_Specified: boolean;
    FVENPASS: string;
    FVENPASS_Specified: boolean;
    Fsonuclar: ArrayOfSonuc;
    Fsonuclar_Specified: boolean;
    procedure SetVENUSER(Index: Integer; const Astring: string);
    function  VENUSER_Specified(Index: Integer): boolean;
    procedure SetVENPASS(Index: Integer; const Astring: string);
    function  VENPASS_Specified(Index: Integer): boolean;
    procedure Setsonuclar(Index: Integer; const AArrayOfSonuc: ArrayOfSonuc);
  ...
  published
    property VENUSER:  string        Index (IS_OPTN) read FVENUSER write SetVENUSER stored VENUSER_Specified;
    property VENPASS:  string        Index (IS_OPTN) read FVENPASS write SetVENPASS stored VENPASS_Specified;
    property sonuclar: ArrayOfSonuc  Index (IS_OPTN) read Fsonuclar write Setsonuclar stored sonuclar_Specified;
  end;
  ...
  private
    ...
    FCALISMA_TARIHI: string;
    FCALISMA_TARIHI_Specified: boolean;
    FENTEGRASYON_KODU: string;
    FENTEGRASYON_KODU_Specified: boolean;
    FSONUC: string;
    FSONUC_Specified: boolean;
    FCIHAZSONUC: string;
    FCIHAZSONUC_Specified: boolean;
    FEKSONUC1: string;
    FEKSONUC1_Specified: boolean;
    FEKSONUC2: string;
    FEKSONUC2_Specified: boolean;
    ...
    FBIRIM_Specified: boolean;
    FNDARALIK: string;
    FNDARALIK_Specified: boolean;
    FNDUYGUN: string;
    FNDUYGUN_Specified: boolean;
    FDUSUK_YUKSEK: string;
    FDUSUK_YUKSEK_Specified: boolean;
    FPANIK: string;
    FPANIK_Specified: boolean;
    FRET: string;
    FRET_Specified: boolean;
    procedure SetCALISMA_TARIHI(Index: Integer; const Astring: string);
    function  CALISMA_TARIHI_Specified(Index: Integer): boolean;
    procedure SetENTEGRASYON_KODU(Index: Integer; const Astring: string);
    function  ENTEGRASYON_KODU_Specified(Index: Integer): boolean;
    procedure SetSONUC(Index: Integer; const Astring: string);
    function  SONUC_Specified(Index: Integer): boolean;
    procedure SetCIHAZSONUC(Index: Integer; const Astring: string);
    function  CIHAZSONUC_Specified(Index: Integer): boolean;
    procedure SetEKSONUC1(Index: Integer; const Astring: string);
    function  EKSONUC1_Specified(Index: Integer): boolean;
    procedure SetEKSONUC2(Index: Integer; const Astring: string);
    function  EKSONUC2_Specified(Index: Integer): boolean;
    ...
    procedure SetBIRIM(Index: Integer; const Astring: string);
    function  BIRIM_Specified(Index: Integer): boolean;
    procedure SetNDARALIK(Index: Integer; const Astring: string);
    function  NDARALIK_Specified(Index: Integer): boolean;
    procedure SetNDUYGUN(Index: Integer; const Astring: string);
    function  NDUYGUN_Specified(Index: Integer): boolean;
    procedure SetDUSUK_YUKSEK(Index: Integer; const Astring: string);
    function  DUSUK_YUKSEK_Specified(Index: Integer): boolean;
    procedure SetPANIK(Index: Integer; const Astring: string);
    function  PANIK_Specified(Index: Integer): boolean;
    procedure SetRET(Index: Integer; const Astring: string);
    function  RET_Specified(Index: Integer): boolean;
  published
    property SONUC_ID:         Integer  read FSONUC_ID write FSONUC_ID;
    property ORNEKNO:          Integer  read FORNEKNO write FORNEKNO;
    property CALISMA_TARIHI:   string   Index (IS_OPTN) read FCALISMA_TARIHI write SetCALISMA_TARIHI stored CALISMA_TARIHI_Specified;
    property ENTEGRASYON_KODU: string   Index (IS_OPTN) read FENTEGRASYON_KODU write SetENTEGRASYON_KODU stored ENTEGRASYON_KODU_Specified;
    property SONUC:            string   Index (IS_OPTN) read FSONUC write SetSONUC stored SONUC_Specified;
    property CIHAZSONUC:       string   Index (IS_OPTN) read FCIHAZSONUC write SetCIHAZSONUC stored CIHAZSONUC_Specified;
    property EKSONUC1:         string   Index (IS_OPTN) read FEKSONUC1 write SetEKSONUC1 stored EKSONUC1_Specified;
    property EKSONUC2:         string   Index (IS_OPTN) read FEKSONUC2 write SetEKSONUC2 stored EKSONUC2_Specified;
    property ACIKLAMA:         string   Index (IS_OPTN) read FACIKLAMA write SetACIKLAMA stored ACIKLAMA_Specified;
    property BIRIM:            string   Index (IS_OPTN) read FBIRIM write SetBIRIM stored BIRIM_Specified;
    property NDARALIK:         string   Index (IS_OPTN) read FNDARALIK write SetNDARALIK stored NDARALIK_Specified;
    property NDUYGUN:          string   Index (IS_OPTN) read FNDUYGUN write SetNDUYGUN stored NDUYGUN_Specified;
    property DUSUK_YUKSEK:     string   Index (IS_OPTN) read FDUSUK_YUKSEK write SetDUSUK_YUKSEK stored DUSUK_YUKSEK_Specified;
    property PANIK:            string   Index (IS_OPTN) read FPANIK write SetPANIK stored PANIK_Specified;
    property RET:              string   Index (IS_OPTN) read FRET write SetRET stored RET_Specified;
  end;

  ArrayOfKonsultasyon = array of Konsultasyon;   { "http://tempuri.org/"[GblCplx] }


  // ************************************************************************ //
  // XML       : KonsultasyonSorguSonuc, global, <complexType>
  // Namespace : http://tempuri.org/
  // ************************************************************************ //
  KonsultasyonSorguSonuc = class(TRemotable)
  private
    FislemSonuc: IslemSonuc;
    FislemSonuc_Specified: boolean;
    FkonsultasyonList: ArrayOfKonsultasyon;
    FkonsultasyonList_Specified: boolean;
    procedure SetislemSonuc(Index: Integer; const AIslemSonuc: IslemSonuc);
    function  islemSonuc_Specified(Index: Integer): boolean;
    procedure SetkonsultasyonList(Index: Integer; const AArrayOfKonsultasyon: ArrayOfKonsultasyon);
    function  konsultasyonList_Specified(Index: Integer): boolean;
  public
    destructor Destroy; override;
  published
    property islemSonuc:       IslemSonuc           Index (IS_OPTN) read FislemSonuc write SetislemSonuc stored islemSonuc_Specified;
    property konsultasyonList: ArrayOfKonsultasyon  Index (IS_OPTN) read FkonsultasyonList write SetkonsultasyonList stored konsultasyonList_Specified;
  end;
  ...
  // ************************************************************************ //
  // XML       : Konsultasyon, global, <complexType>
  // Namespace : http://tempuri.org/
  // ************************************************************************ //
  Konsultasyon = class(TRemotable)
  private
    FKonsultasyonID: Integer;
    FDosyaNo: string;
    ...
    FTalepEdenTCKimlikNo: string;
    FTalepEdenTCKimlikNo_Specified: boolean;
    FTalepEdenAdSoyad: string;
    FTalepEdenAdSoyad_Specified: boolean;
    FTalepEdilenTCKimlikNo: string;
    FTalepEdilenTCKimlikNo_Specified: boolean;
    FTalepEdilenAdSoyad: string;
    FTalepEdilenAdSoyad_Specified: boolean;
    FTalepNot: string;
    FTalepNot_Specified: boolean;
    FKonsBasTarih: string;
    FKonsBasTarih_Specified: boolean;
    FKonsBitTarih: string;
    FKonsBitTarih_Specified: boolean;
    FKonsLabIci: string;
    FKonsLabIci_Specified: boolean;
    FKonsultasyonHex: string;
    FKonsultasyonHex_Specified: boolean;
    FKayitTarihi: string;
    ...
    procedure SetTalepEdenTCKimlikNo(Index: Integer; const Astring: string);
    function  TalepEdenTCKimlikNo_Specified(Index: Integer): boolean;
    procedure SetTalepEdenAdSoyad(Index: Integer; const Astring: string);
    function  TalepEdenAdSoyad_Specified(Index: Integer): boolean;
    procedure SetTalepEdilenTCKimlikNo(Index: Integer; const Astring: string);
    function  TalepEdilenTCKimlikNo_Specified(Index: Integer): boolean;
    procedure SetTalepEdilenAdSoyad(Index: Integer; const Astring: string);
    function  TalepEdilenAdSoyad_Specified(Index: Integer): boolean;
    procedure SetTalepNot(Index: Integer; const Astring: string);
    function  TalepNot_Specified(Index: Integer): boolean;
    procedure SetKonsBasTarih(Index: Integer; const Astring: string);
    function  KonsBasTarih_Specified(Index: Integer): boolean;
    procedure SetKonsBitTarih(Index: Integer; const Astring: string);
    function  KonsBitTarih_Specified(Index: Integer): boolean;
    procedure SetKonsLabIci(Index: Integer; const Astring: string);
    function  KonsLabIci_Specified(Index: Integer): boolean;
    procedure SetKonsultasyonHex(Index: Integer; const Astring: string);
    function  KonsultasyonHex_Specified(Index: Integer): boolean;
  ...
  published
    ...
    property ProtokolNo:            string   Index (IS_OPTN) read FProtokolNo write SetProtokolNo stored ProtokolNo_Specified;
    property Tarih:                 string   Index (IS_OPTN) read FTarih write SetTarih stored Tarih_Specified;
    property TalepEdenTCKimlikNo:   string   Index (IS_OPTN) read FTalepEdenTCKimlikNo write SetTalepEdenTCKimlikNo stored TalepEdenTCKimlikNo_Specified;
    property TalepEdenAdSoyad:      string   Index (IS_OPTN) read FTalepEdenAdSoyad write SetTalepEdenAdSoyad stored TalepEdenAdSoyad_Specified;
    property TalepEdilenTCKimlikNo: string   Index (IS_OPTN) read FTalepEdilenTCKimlikNo write SetTalepEdilenTCKimlikNo stored TalepEdilenTCKimlikNo_Specified;
    property TalepEdilenAdSoyad:    string   Index (IS_OPTN) read FTalepEdilenAdSoyad write SetTalepEdilenAdSoyad stored TalepEdilenAdSoyad_Specified;
    property TalepNot:              string   Index (IS_OPTN) read FTalepNot write SetTalepNot stored TalepNot_Specified;
    property KonsBasTarih:          string   Index (IS_OPTN) read FKonsBasTarih write SetKonsBasTarih stored KonsBasTarih_Specified;
    property KonsBitTarih:          string   Index (IS_OPTN) read FKonsBitTarih write SetKonsBitTarih stored KonsBitTarih_Specified;
    property KonsLabIci:            string   Index (IS_OPTN) read FKonsLabIci write SetKonsLabIci stored KonsLabIci_Specified;
    property KonsultasyonHex:       string   Index (IS_OPTN) read FKonsultasyonHex write SetKonsultasyonHex stored KonsultasyonHex_Specified;
    property KayitTarihi:           string   Index (IS_OPTN) read FKayitTarihi write SetKayitTarihi stored KayitTarihi_Specified;
  end;

  ArrayOfSonucYazDur = array of SonucYazDur;    { "http://tempuri.org/"[GblCplx] }


  // ************************************************************************ //
  // XML       : SonucRes, global, <complexType>
  // Namespace : http://tempuri.org/
  // ************************************************************************ //
  SonucRes = class(TRemotable)
  private
    FGenelRes: Integer;
    FGenelHataMesaji: string;
    FGenelHataMesaji_Specified: boolean;
    FsonucYazDurumlari: ArrayOfSonucYazDur;
    FsonucYazDurumlari_Specified: boolean;
    procedure SetGenelHataMesaji(Index: Integer; const Astring: string);
    function  GenelHataMesaji_Specified(Index: Integer): boolean;
    procedure SetsonucYazDurumlari(Index: Integer; const AArrayOfSonucYazDur: ArrayOfSonucYazDur);
    function  sonucYazDurumlari_Specified(Index: Integer): boolean;
  public
    destructor Destroy; override;
  published
    property GenelRes:          Integer             read FGenelRes write FGenelRes;
    property GenelHataMesaji:   string              Index (IS_OPTN) read FGenelHataMesaji write SetGenelHataMesaji stored GenelHataMesaji_Specified;
    property sonucYazDurumlari: ArrayOfSonucYazDur  Index (IS_OPTN) read FsonucYazDurumlari write SetsonucYazDurumlari stored sonucYazDurumlari_Specified;
  end;
  ...
  private
    ...
    FdoktorBilgi: DoktorBilgi;
    FdoktorBilgi_Specified: boolean;
    procedure SetislemSonuc(Index: Integer; const AIslemSonuc: IslemSonuc);
    function  islemSonuc_Specified(Index: Integer): boolean;
    ...
    procedure SetdoktorBilgi(Index: Integer; const ADoktorBilgi: DoktorBilgi);
    function  doktorBilgi_Specified(Index: Integer): boolean;
  public
    destructor Destroy; override;
  published
    property islemSonuc:   IslemSonuc   Index (IS_OPTN) read FislemSonuc write SetislemSonuc stored islemSonuc_Specified;
    ...
    property doktorBilgi:  DoktorBilgi  Index (IS_OPTN) read FdoktorBilgi write SetdoktorBilgi stored doktorBilgi_Specified;
  end;
  ...
  // ************************************************************************ //
  // XML       : SonucYazDur, global, <complexType>
  // Namespace : http://tempuri.org/
  // ************************************************************************ //
  SonucYazDur = class(TRemotable)
  private
    FSonucID: Integer;
    FOrnekNo: Integer;
    FEntegrasyonKodu: string;
    FEntegrasyonKodu_Specified: boolean;
    FRes: Integer;
    FMesaj: string;
    FMesaj_Specified: boolean;
    procedure SetEntegrasyonKodu(Index: Integer; const Astring: string);
    function  EntegrasyonKodu_Specified(Index: Integer): boolean;
    procedure SetMesaj(Index: Integer; const Astring: string);
    function  Mesaj_Specified(Index: Integer): boolean;
  published
    property SonucID:         Integer  read FSonucID write FSonucID;
    property OrnekNo:         Integer  read FOrnekNo write FOrnekNo;
    property EntegrasyonKodu: string   Index (IS_OPTN) read FEntegrasyonKodu write SetEntegrasyonKodu stored EntegrasyonKodu_Specified;
    property Res:             Integer  read FRes write FRes;
  ...
  // style     : document
  // use       : literal
  // binding   : AlisWSSoap12                                                                              kurum
  // service   : AlisWS
  // port      : AlisWSSoap12
  // URL       : http://213.14.77.58/AlisWS/AlisWS.asmx
  // ************************************************************************ //
  AlisWSSoap = interface(IInvokable)
  ['{082B82C7-4AC1-7AF7-68A3-CDD5439D27A0}']
    function  ALISSonucDosyaKaydet(const VENUSER: string; const VENPASS: string; const SONUC_ID: Integer; const ORNEKNO: Integer; const ENTEGRASYON_KODU: string; const FILE_NAME: string; 
                                   const FILE_EXTENSION: string; const FILE_BYTES: TByteDynArray): IslemSonuc; stdcall;
    function  ALISSonucDosyaSorgula(const VENUSER: string; const VENPASS: string; const SONUC_ID: Integer; const ORNEKNO: Integer; const ENTEGRASYON_KODU: string): SonucDosyaResult; stdcall;
    function  DisLabUrunIstemKaydet(const VENUSER: string; const VENPASS: string; const ISTEYEN_MERKEZ_KODU: string; const ISTEM_TARIHI: TXSDateTime; const ACIL_MI: string; const HASTA_AD: string;
                                    const HASTA_SOYAD: string; const ACIL_NEDEN: string; const KAN_BILESENI: string; const KAN_GRUBU: string; const ISTEM_ADET: Integer; 
                                    const HACIM: Integer; const NOTLAR: string; const SUBGRUP: string; const FILTRELEME: string; const ISINLAMA: string; 
                                    const YIKAMA: string; const BUFFY_COAT: string): MethodSonuc; stdcall;
    function  DisLabUrunIstemIptal(const VENUSER: string; const VENPASS: string; const ISTEYEN_MERKEZ_KODU: string; const DISLAB_URUN_ISTEM_ID: Integer): MethodSonuc; stdcall;
    function  DislabUrunIstemSorgula(const VENUSER: string; const VENPASS: string; const ISTEYEN_MERKEZ_KODU: string; const BASTAR: TXSDateTime; const BITTAR: TXSDateTime): DisLabUrunIstemSonuc; stdcall;
    function  ALISHastaTumSonuc(const VENUSER: string; const VENPASS: string; const TC_KIMLIKNO: string; const BASTAR: string; const BITTAR: string): ArrayOfSonucDurum; stdcall;
    function  ALISHastaTestIstenebilirMi(const entegRec: EntegRec): IslemSonuc; stdcall;
    function  LabKonsultasyonTalep(const VENUSER: string; const VENPASS: string; const HBYS_DOSYA_NO: string; const PROTOKOL_NO: string; const TALEP_EDEN_TCKIMLIKNO: string; const TALEP_EDEN_AD: string; 
                                   const TALEP_EDEN_SOYAD: string; const TALEP_EDILEN_TCKIMLIKNO: string; const TALEP_EDILEN_AD: string; const TALEP_EDILEN_SOYAD: string; const TALEP_TARIH: string;
                                   const TALEP_NOT: string): KonsultasyonTalepSonuc; stdcall;
    function  LabKonsultasyonSorgula(const VENUSER: string; const VENPASS: string; const HBYS_DOSYA_NO: string; const PROTOKOL_NO: string; const KONSULTASYON_ID: Integer): KonsultasyonSorguSonuc; stdcall;
    function  LabIciKonsultasyonSorgula(const VENUSER: string; const VENPASS: string; const SORGU_BASTARIH: string; const SORGU_BITTARIH: string): KonsultasyonSorguSonuc; stdcall;
    function  LabKonsultasyonAlindi(const VENUSER: string; const VENPASS: string; const KONSULTASYON_ID_LIST: ArrayOfInt): IslemSonuc; stdcall;
    function  ALISTopluSonucYaz(const sonucReq: SonucReq): SonucRes; stdcall;
    ...
    function  ALISSonucYaz(const VENUSER: string; const VENPASS: string; const SONUC_ID: Integer; const ORNEKNO: Integer; const CALISMA_TARIHI: string; const ENTEGRASYON_KODU: string;
                           ...
                           const BIRIM: string; const NDARALIK: string; const NDUYGUN: string; const DUSUK_YUKSEK: string; const PANIK: string; 
                           const RET: string): IslemSonuc; stdcall;
    function  ALISSonucYazBasit(const VENUSER: string; const VENPASS: string; const SONUC_ID: Integer; const ORNEKNO: Integer; const CALISMA_TARIHI: string; const ENTEGRASYON_KODU: string; 
                                const SONUC: string; const CIHAZSONUC: string; const EKSONUC1: string; const EKSONUC2: string; const ACIKLAMA: string; 
                                const BIRIM: string; const NDARALIK: string; const NDUYGUN: string; const DUSUK_YUKSEK: string; const PANIK: string; 
                                const RET: string): Integer; stdcall;
    function  ALISIslemBildir(const VENUSER: string; const VENPASS: string; const ORNEKNO: Integer; const BARKODNO: string; const TESTLER: string; const ISLEM: Integer; 
                              const ISLEM_TARIH: string; const ISLEM_YAPAN: string; const ISLEM_ACIKLAMA: string): string; stdcall;
...
const
  defWSDL = 'http://213.14.77.58/AlisWS/?wsdl';
  defURL  = 'http://213.14.77.58/AlisWS/AlisWS.asmx';
  defSvc  = 'AlisWS';
  defPrt  = 'AlisWSSoap12';
var
  RIO: THTTPRIO;
...
destructor KonsultasyonTalepSonuc.Destroy;
begin
  SysUtils.FreeAndNil(FislemSonuc);
  inherited Destroy;
end;

procedure KonsultasyonTalepSonuc.SetislemSonuc(Index: Integer; const AIslemSonuc: IslemSonuc);
begin
  FislemSonuc := AIslemSonuc;
  FislemSonuc_Specified := True;
end;

function KonsultasyonTalepSonuc.islemSonuc_Specified(Index: Integer): boolean;
begin
...
procedure SonucDurum.SetSONUC_DOSYASI_VAR(Index: Integer; const Astring: string);
begin
  FSONUC_DOSYASI_VAR := Astring;
  FSONUC_DOSYASI_VAR_Specified := True;
end;

function SonucDurum.SONUC_DOSYASI_VAR_Specified(Index: Integer): boolean;
begin
  Result := FSONUC_DOSYASI_VAR_Specified;
end;
...
destructor DisLabUrunIstemSonuc.Destroy;
var
  I: Integer;
begin
  for I := 0 to System.Length(FDisLabUrunIstemleri)-1 do
    SysUtils.FreeAndNil(FDisLabUrunIstemleri[I]);
  System.SetLength(FDisLabUrunIstemleri, 0);
  SysUtils.FreeAndNil(FmethodSonuc);
  inherited Destroy;
end;

procedure DisLabUrunIstemSonuc.SetmethodSonuc(Index: Integer; const AMethodSonuc: MethodSonuc);
begin
  FmethodSonuc := AMethodSonuc;
  FmethodSonuc_Specified := True;
end;

function DisLabUrunIstemSonuc.methodSonuc_Specified(Index: Integer): boolean;
begin
  Result := FmethodSonuc_Specified;
end;

procedure DisLabUrunIstemSonuc.SetDisLabUrunIstemleri(Index: Integer; const AArrayOfDisLabUrunIstem: ArrayOfDisLabUrunIstem);
begin
  FDisLabUrunIstemleri := AArrayOfDisLabUrunIstem;
  FDisLabUrunIstemleri_Specified := True;
end;

function DisLabUrunIstemSonuc.DisLabUrunIstemleri_Specified(Index: Integer): boolean;
begin
  Result := FDisLabUrunIstemleri_Specified;
end;

destructor DisLabUrunIstem.Destroy;
begin
  SysUtils.FreeAndNil(FSON_KULLANMA_TARIHI);
  SysUtils.FreeAndNil(FBAGIS_TARIHI);
  inherited Destroy;
end;

procedure DisLabUrunIstem.SetISBT_UNITE_NO(Index: Integer; const Astring: string);
begin
  FISBT_UNITE_NO := Astring;
  FISBT_UNITE_NO_Specified := True;
end;

function DisLabUrunIstem.ISBT_UNITE_NO_Specified(Index: Integer): boolean;
begin
  Result := FISBT_UNITE_NO_Specified;
end;

procedure DisLabUrunIstem.SetISBT_BILESEN_KODU(Index: Integer; const Astring: string);
begin
  FISBT_BILESEN_KODU := Astring;
  FISBT_BILESEN_KODU_Specified := True;
end;

function DisLabUrunIstem.ISBT_BILESEN_KODU_Specified(Index: Integer): boolean;
begin
  Result := FISBT_BILESEN_KODU_Specified;
end;

procedure DisLabUrunIstem.SetKAN_GRUBU(Index: Integer; const Astring: string);
begin
  FKAN_GRUBU := Astring;
  FKAN_GRUBU_Specified := True;
end;

function DisLabUrunIstem.KAN_GRUBU_Specified(Index: Integer): boolean;
begin
  Result := FKAN_GRUBU_Specified;
end;

procedure DisLabUrunIstem.SetKAN_BILESENI(Index: Integer; const Astring: string);
begin
  FKAN_BILESENI := Astring;
  FKAN_BILESENI_Specified := True;
end;

function DisLabUrunIstem.KAN_BILESENI_Specified(Index: Integer): boolean;
begin
  Result := FKAN_BILESENI_Specified;
end;

procedure DisLabUrunIstem.SetISLEM_DURUMU(Index: Integer; const Astring: string);
begin
  FISLEM_DURUMU := Astring;
  FISLEM_DURUMU_Specified := True;
end;

function DisLabUrunIstem.ISLEM_DURUMU_Specified(Index: Integer): boolean;
begin
  Result := FISLEM_DURUMU_Specified;
end;

destructor SonucDosyaResult.Destroy;
var
  I: Integer;
begin
  for I := 0 to System.Length(FDosyalar)-1 do
    SysUtils.FreeAndNil(FDosyalar[I]);
  System.SetLength(FDosyalar, 0);
  SysUtils.FreeAndNil(FislemSonuc);
  inherited Destroy;
end;

procedure SonucDosyaResult.SetislemSonuc(Index: Integer; const AIslemSonuc: IslemSonuc);
begin
  FislemSonuc := AIslemSonuc;
  FislemSonuc_Specified := True;
end;

function SonucDosyaResult.islemSonuc_Specified(Index: Integer): boolean;
begin
  Result := FislemSonuc_Specified;
end;

procedure SonucDosyaResult.SetDosyalar(Index: Integer; const AArrayOfSonucDosya: ArrayOfSonucDosya);
begin
  FDosyalar := AArrayOfSonucDosya;
  FDosyalar_Specified := True;
end;

function SonucDosyaResult.Dosyalar_Specified(Index: Integer): boolean;
begin
  Result := FDosyalar_Specified;
end;

procedure MethodSonuc.SetHataMesaji(Index: Integer; const Astring: string);
begin
  FHataMesaji := Astring;
  FHataMesaji_Specified := True;
end;

function MethodSonuc.HataMesaji_Specified(Index: Integer): boolean;
begin
  Result := FHataMesaji_Specified;
end;

procedure MethodSonuc.SetUyarýMesaji(Index: Integer; const Astring: string);
begin
  FUyarýMesaji := Astring;
  FUyarýMesaji_Specified := True;
end;

function MethodSonuc.UyarýMesaji_Specified(Index: Integer): boolean;
begin
  Result := FUyarýMesaji_Specified;
end;

procedure SonucDosya.SetTEST_ADI(Index: Integer; const Astring: string);
begin
  FTEST_ADI := Astring;
  FTEST_ADI_Specified := True;
end;

function SonucDosya.TEST_ADI_Specified(Index: Integer): boolean;
begin
  Result := FTEST_ADI_Specified;
end;

procedure SonucDosya.SetFILE_EXTENSION(Index: Integer; const Astring: string);
begin
  FFILE_EXTENSION := Astring;
  FFILE_EXTENSION_Specified := True;
end;

function SonucDosya.FILE_EXTENSION_Specified(Index: Integer): boolean;
begin
  Result := FFILE_EXTENSION_Specified;
end;

procedure SonucDosya.SetFILE_ACIKLAMA(Index: Integer; const Astring: string);
begin
  FFILE_ACIKLAMA := Astring;
  FFILE_ACIKLAMA_Specified := True;
end;

function SonucDosya.FILE_ACIKLAMA_Specified(Index: Integer): boolean;
begin
  Result := FFILE_ACIKLAMA_Specified;
end;

procedure SonucDosya.SetFILE_BYTES(Index: Integer; const ATByteDynArray: TByteDynArray);
begin
  FFILE_BYTES := ATByteDynArray;
  FFILE_BYTES_Specified := True;
end;

function SonucDosya.FILE_BYTES_Specified(Index: Integer): boolean;
begin
  Result := FFILE_BYTES_Specified;
end;
...
procedure SonucReq.SetVENUSER(Index: Integer; const Astring: string);
begin
  FVENUSER := Astring;
  FVENUSER_Specified := True;
end;

function SonucReq.VENUSER_Specified(Index: Integer): boolean;
begin
  Result := FVENUSER_Specified;
end;

procedure SonucReq.SetVENPASS(Index: Integer; const Astring: string);
begin
  FVENPASS := Astring;
  FVENPASS_Specified := True;
end;

function SonucReq.VENPASS_Specified(Index: Integer): boolean;
begin
  Result := FVENPASS_Specified;
end;

procedure SonucReq.Setsonuclar(Index: Integer; const AArrayOfSonuc: ArrayOfSonuc);
begin
  Fsonuclar := AArrayOfSonuc;
  Fsonuclar_Specified := True;
end;

function SonucReq.sonuclar_Specified(Index: Integer): boolean;
begin
  Result := Fsonuclar_Specified;
end;

procedure Sonuc.SetCALISMA_TARIHI(Index: Integer; const Astring: string);
begin
  FCALISMA_TARIHI := Astring;
  FCALISMA_TARIHI_Specified := True;
end;

function Sonuc.CALISMA_TARIHI_Specified(Index: Integer): boolean;
begin
  Result := FCALISMA_TARIHI_Specified;
end;

procedure Sonuc.SetENTEGRASYON_KODU(Index: Integer; const Astring: string);
begin
  FENTEGRASYON_KODU := Astring;
  FENTEGRASYON_KODU_Specified := True;
end;

function Sonuc.ENTEGRASYON_KODU_Specified(Index: Integer): boolean;
begin
  Result := FENTEGRASYON_KODU_Specified;
end;

procedure Sonuc.SetSONUC(Index: Integer; const Astring: string);
begin
  FSONUC := Astring;
  FSONUC_Specified := True;
end;

function Sonuc.SONUC_Specified(Index: Integer): boolean;
begin
  Result := FSONUC_Specified;
end;

procedure Sonuc.SetCIHAZSONUC(Index: Integer; const Astring: string);
begin
  FCIHAZSONUC := Astring;
  FCIHAZSONUC_Specified := True;
end;

function Sonuc.CIHAZSONUC_Specified(Index: Integer): boolean;
begin
  Result := FCIHAZSONUC_Specified;
end;

procedure Sonuc.SetEKSONUC1(Index: Integer; const Astring: string);
begin
  FEKSONUC1 := Astring;
  FEKSONUC1_Specified := True;
end;

function Sonuc.EKSONUC1_Specified(Index: Integer): boolean;
begin
  Result := FEKSONUC1_Specified;
end;

procedure Sonuc.SetEKSONUC2(Index: Integer; const Astring: string);
begin
  FEKSONUC2 := Astring;
  FEKSONUC2_Specified := True;
end;

function Sonuc.EKSONUC2_Specified(Index: Integer): boolean;
begin
  Result := FEKSONUC2_Specified;
end;
...
procedure Sonuc.SetBIRIM(Index: Integer; const Astring: string);
begin
  FBIRIM := Astring;
  FBIRIM_Specified := True;
end;

function Sonuc.BIRIM_Specified(Index: Integer): boolean;
begin
  Result := FBIRIM_Specified;
end;

procedure Sonuc.SetNDARALIK(Index: Integer; const Astring: string);
begin
  FNDARALIK := Astring;
  FNDARALIK_Specified := True;
end;

function Sonuc.NDARALIK_Specified(Index: Integer): boolean;
begin
  Result := FNDARALIK_Specified;
end;

procedure Sonuc.SetNDUYGUN(Index: Integer; const Astring: string);
begin
  FNDUYGUN := Astring;
  FNDUYGUN_Specified := True;
end;

function Sonuc.NDUYGUN_Specified(Index: Integer): boolean;
begin
  Result := FNDUYGUN_Specified;
end;

procedure Sonuc.SetDUSUK_YUKSEK(Index: Integer; const Astring: string);
begin
  FDUSUK_YUKSEK := Astring;
  FDUSUK_YUKSEK_Specified := True;
end;

function Sonuc.DUSUK_YUKSEK_Specified(Index: Integer): boolean;
begin
  Result := FDUSUK_YUKSEK_Specified;
end;

procedure Sonuc.SetPANIK(Index: Integer; const Astring: string);
begin
  FPANIK := Astring;
  FPANIK_Specified := True;
end;

function Sonuc.PANIK_Specified(Index: Integer): boolean;
begin
  Result := FPANIK_Specified;
end;

procedure Sonuc.SetRET(Index: Integer; const Astring: string);
begin
  FRET := Astring;
  FRET_Specified := True;
end;

function Sonuc.RET_Specified(Index: Integer): boolean;
begin
  Result := FRET_Specified;
end;

destructor KonsultasyonSorguSonuc.Destroy;
var
  I: Integer;
begin
  for I := 0 to System.Length(FkonsultasyonList)-1 do
    SysUtils.FreeAndNil(FkonsultasyonList[I]);
  System.SetLength(FkonsultasyonList, 0);
  SysUtils.FreeAndNil(FislemSonuc);
  inherited Destroy;
end;

procedure KonsultasyonSorguSonuc.SetislemSonuc(Index: Integer; const AIslemSonuc: IslemSonuc);
begin
  FislemSonuc := AIslemSonuc;
  FislemSonuc_Specified := True;
end;

function KonsultasyonSorguSonuc.islemSonuc_Specified(Index: Integer): boolean;
begin
  Result := FislemSonuc_Specified;
end;

procedure KonsultasyonSorguSonuc.SetkonsultasyonList(Index: Integer; const AArrayOfKonsultasyon: ArrayOfKonsultasyon);
begin
  FkonsultasyonList := AArrayOfKonsultasyon;
  FkonsultasyonList_Specified := True;
end;

function KonsultasyonSorguSonuc.konsultasyonList_Specified(Index: Integer): boolean;
begin
  Result := FkonsultasyonList_Specified;
end;

procedure Konsultasyon.SetDosyaNo(Index: Integer; const Astring: string);
begin
  FDosyaNo := Astring;
  FDosyaNo_Specified := True;
end;

function Konsultasyon.DosyaNo_Specified(Index: Integer): boolean;
begin
  Result := FDosyaNo_Specified;
end;

procedure Konsultasyon.SetProtokolNo(Index: Integer; const Astring: string);
begin
  FProtokolNo := Astring;
  FProtokolNo_Specified := True;
end;

function Konsultasyon.ProtokolNo_Specified(Index: Integer): boolean;
begin
  Result := FProtokolNo_Specified;
end;

procedure Konsultasyon.SetTarih(Index: Integer; const Astring: string);
begin
  FTarih := Astring;
  FTarih_Specified := True;
end;

function Konsultasyon.Tarih_Specified(Index: Integer): boolean;
begin
  Result := FTarih_Specified;
end;

procedure Konsultasyon.SetTalepEdenTCKimlikNo(Index: Integer; const Astring: string);
begin
  FTalepEdenTCKimlikNo := Astring;
  FTalepEdenTCKimlikNo_Specified := True;
end;

function Konsultasyon.TalepEdenTCKimlikNo_Specified(Index: Integer): boolean;
begin
  Result := FTalepEdenTCKimlikNo_Specified;
end;

procedure Konsultasyon.SetTalepEdenAdSoyad(Index: Integer; const Astring: string);
begin
  FTalepEdenAdSoyad := Astring;
  FTalepEdenAdSoyad_Specified := True;
end;

function Konsultasyon.TalepEdenAdSoyad_Specified(Index: Integer): boolean;
begin
  Result := FTalepEdenAdSoyad_Specified;
end;

procedure Konsultasyon.SetTalepEdilenTCKimlikNo(Index: Integer; const Astring: string);
begin
  FTalepEdilenTCKimlikNo := Astring;
  FTalepEdilenTCKimlikNo_Specified := True;
end;

function Konsultasyon.TalepEdilenTCKimlikNo_Specified(Index: Integer): boolean;
begin
  Result := FTalepEdilenTCKimlikNo_Specified;
end;

procedure Konsultasyon.SetTalepEdilenAdSoyad(Index: Integer; const Astring: string);
begin
  FTalepEdilenAdSoyad := Astring;
  FTalepEdilenAdSoyad_Specified := True;
end;

function Konsultasyon.TalepEdilenAdSoyad_Specified(Index: Integer): boolean;
begin
  Result := FTalepEdilenAdSoyad_Specified;
end;

procedure Konsultasyon.SetTalepNot(Index: Integer; const Astring: string);
begin
  FTalepNot := Astring;
  FTalepNot_Specified := True;
end;

function Konsultasyon.TalepNot_Specified(Index: Integer): boolean;
begin
  Result := FTalepNot_Specified;
end;

procedure Konsultasyon.SetKonsBasTarih(Index: Integer; const Astring: string);
begin
  FKonsBasTarih := Astring;
  FKonsBasTarih_Specified := True;
end;

function Konsultasyon.KonsBasTarih_Specified(Index: Integer): boolean;
begin
  Result := FKonsBasTarih_Specified;
end;

procedure Konsultasyon.SetKonsBitTarih(Index: Integer; const Astring: string);
begin
  FKonsBitTarih := Astring;
  FKonsBitTarih_Specified := True;
end;

function Konsultasyon.KonsBitTarih_Specified(Index: Integer): boolean;
begin
  Result := FKonsBitTarih_Specified;
end;

procedure Konsultasyon.SetKonsLabIci(Index: Integer; const Astring: string);
begin
  FKonsLabIci := Astring;
  FKonsLabIci_Specified := True;
end;

function Konsultasyon.KonsLabIci_Specified(Index: Integer): boolean;
begin
  Result := FKonsLabIci_Specified;
end;

procedure Konsultasyon.SetKonsultasyonHex(Index: Integer; const Astring: string);
begin
  FKonsultasyonHex := Astring;
  FKonsultasyonHex_Specified := True;
end;

function Konsultasyon.KonsultasyonHex_Specified(Index: Integer): boolean;
begin
  Result := FKonsultasyonHex_Specified;
end;

procedure Konsultasyon.SetKayitTarihi(Index: Integer; const Astring: string);
begin
  FKayitTarihi := Astring;
  FKayitTarihi_Specified := True;
end;

function Konsultasyon.KayitTarihi_Specified(Index: Integer): boolean;
begin
  Result := FKayitTarihi_Specified;
end;

destructor SonucRes.Destroy;
var
  I: Integer;
begin
  for I := 0 to System.Length(FsonucYazDurumlari)-1 do
    SysUtils.FreeAndNil(FsonucYazDurumlari[I]);
  System.SetLength(FsonucYazDurumlari, 0);
  inherited Destroy;
end;

procedure SonucRes.SetGenelHataMesaji(Index: Integer; const Astring: string);
begin
  FGenelHataMesaji := Astring;
  FGenelHataMesaji_Specified := True;
end;

function SonucRes.GenelHataMesaji_Specified(Index: Integer): boolean;
begin
  Result := FGenelHataMesaji_Specified;
end;

procedure SonucRes.SetsonucYazDurumlari(Index: Integer; const AArrayOfSonucYazDur: ArrayOfSonucYazDur);
begin
  FsonucYazDurumlari := AArrayOfSonucYazDur;
  FsonucYazDurumlari_Specified := True;
end;

function SonucRes.sonucYazDurumlari_Specified(Index: Integer): boolean;
begin
  Result := FsonucYazDurumlari_Specified;
end;
...
begin
  SysUtils.FreeAndNil(FislemSonuc);
  SysUtils.FreeAndNil(FdoktorBilgi);
  inherited Destroy;
end;
...
procedure OrnekDurum.SetdoktorBilgi(Index: Integer; const ADoktorBilgi: DoktorBilgi);
begin
  FdoktorBilgi := ADoktorBilgi;
  FdoktorBilgi_Specified := True;
end;

function OrnekDurum.doktorBilgi_Specified(Index: Integer): boolean;
begin
  Result := FdoktorBilgi_Specified;
end;
...
procedure SonucYazDur.SetEntegrasyonKodu(Index: Integer; const Astring: string);
begin
  FEntegrasyonKodu := Astring;
  FEntegrasyonKodu_Specified := True;
end;

function SonucYazDur.EntegrasyonKodu_Specified(Index: Integer): boolean;
begin
  Result := FEntegrasyonKodu_Specified;
end;

procedure SonucYazDur.SetMesaj(Index: Integer; const Astring: string);
begin
  FMesaj := Astring;
  FMesaj_Specified := True;
end;

function SonucYazDur.Mesaj_Specified(Index: Integer): boolean;
begin
...
initialization
  ...
  { AlisWSSoap.ALISSonucDosyaKaydet }
  InvRegistry.RegisterMethodInfo(TypeInfo(AlisWSSoap), 'ALISSonucDosyaKaydet', '',
                                 '[ReturnName="ALISSonucDosyaKaydetResult"]', IS_OPTN);
  { AlisWSSoap.ALISSonucDosyaSorgula }
  InvRegistry.RegisterMethodInfo(TypeInfo(AlisWSSoap), 'ALISSonucDosyaSorgula', '',
                                 '[ReturnName="ALISSonucDosyaSorgulaResult"]', IS_OPTN);
  { AlisWSSoap.DisLabUrunIstemKaydet }
  InvRegistry.RegisterMethodInfo(TypeInfo(AlisWSSoap), 'DisLabUrunIstemKaydet', '',
                                 '[ReturnName="DisLabUrunIstemKaydetResult"]', IS_OPTN);
  { AlisWSSoap.DisLabUrunIstemIptal }
  InvRegistry.RegisterMethodInfo(TypeInfo(AlisWSSoap), 'DisLabUrunIstemIptal', '',
                                 '[ReturnName="DisLabUrunIstemIptalResult"]', IS_OPTN);
  { AlisWSSoap.DislabUrunIstemSorgula }
  InvRegistry.RegisterMethodInfo(TypeInfo(AlisWSSoap), 'DislabUrunIstemSorgula', '',
                                 '[ReturnName="DislabUrunIstemSorgulaResult"]', IS_OPTN);
  { AlisWSSoap.ALISHastaTumSonuc }
  InvRegistry.RegisterMethodInfo(TypeInfo(AlisWSSoap), 'ALISHastaTumSonuc', '',
                                 '[ReturnName="ALISHastaTumSonucResult"]', IS_OPTN);
  InvRegistry.RegisterParamInfo(TypeInfo(AlisWSSoap), 'ALISHastaTumSonuc', 'ALISHastaTumSonucResult', '',
                                '[ArrayItemName="SonucDurum"]');
  { AlisWSSoap.ALISHastaTestIstenebilirMi }
  InvRegistry.RegisterMethodInfo(TypeInfo(AlisWSSoap), 'ALISHastaTestIstenebilirMi', '',
                                 '[ReturnName="ALISHastaTestIstenebilirMiResult"]', IS_OPTN);
  { AlisWSSoap.LabKonsultasyonTalep }
  InvRegistry.RegisterMethodInfo(TypeInfo(AlisWSSoap), 'LabKonsultasyonTalep', '',
                                 '[ReturnName="LabKonsultasyonTalepResult"]', IS_OPTN);
  { AlisWSSoap.LabKonsultasyonSorgula }
  InvRegistry.RegisterMethodInfo(TypeInfo(AlisWSSoap), 'LabKonsultasyonSorgula', '',
                                 '[ReturnName="LabKonsultasyonSorgulaResult"]', IS_OPTN);
  { AlisWSSoap.LabIciKonsultasyonSorgula }
  InvRegistry.RegisterMethodInfo(TypeInfo(AlisWSSoap), 'LabIciKonsultasyonSorgula', '',
                                 '[ReturnName="LabIciKonsultasyonSorgulaResult"]', IS_OPTN);
  { AlisWSSoap.LabKonsultasyonAlindi }
  InvRegistry.RegisterMethodInfo(TypeInfo(AlisWSSoap), 'LabKonsultasyonAlindi', '',
                                 '[ReturnName="LabKonsultasyonAlindiResult"]', IS_OPTN);
  InvRegistry.RegisterParamInfo(TypeInfo(AlisWSSoap), 'LabKonsultasyonAlindi', 'KONSULTASYON_ID_LIST', '',
                                '[ArrayItemName="int"]');
  { AlisWSSoap.ALISTopluSonucYaz }
  InvRegistry.RegisterMethodInfo(TypeInfo(AlisWSSoap), 'ALISTopluSonucYaz', '',
                                 '[ReturnName="ALISTopluSonucYazResult"]', IS_OPTN);
  { AlisWSSoap.ALISKayitEkleBasit }
  InvRegistry.RegisterMethodInfo(TypeInfo(AlisWSSoap), 'ALISKayitEkleBasit', '',
                                 '[ReturnName="ALISKayitEkleBasitResult"]');
  { AlisWSSoap.ALISKayitEkleAdv }
  InvRegistry.RegisterMethodInfo(TypeInfo(AlisWSSoap), 'ALISKayitEkleAdv', '',
                                 '[ReturnName="ALISKayitEkleAdvResult"]', IS_OPTN);
  { AlisWSSoap.ALISTetkikEkle }
  InvRegistry.RegisterMethodInfo(TypeInfo(AlisWSSoap), 'ALISTetkikEkle', '',
                                 '[ReturnName="ALISTetkikEkleResult"]', IS_OPTN);
  { AlisWSSoap.ALISOrnekSil }
  InvRegistry.RegisterMethodInfo(TypeInfo(AlisWSSoap), 'ALISOrnekSil', '',
                                 '[ReturnName="ALISOrnekSilResult"]', IS_OPTN);
  { AlisWSSoap.ALISTetkikSil }
  InvRegistry.RegisterMethodInfo(TypeInfo(AlisWSSoap), 'ALISTetkikSil', '',
                                 '[ReturnName="ALISTetkikSilResult"]', IS_OPTN);
  { AlisWSSoap.ALISKayitSorguTamamlandi }
  InvRegistry.RegisterMethodInfo(TypeInfo(AlisWSSoap), 'ALISKayitSorguTamamlandi', '',
                                 '[ReturnName="ALISKayitSorguTamamlandiResult"]', IS_OPTN);
  InvRegistry.RegisterParamInfo(TypeInfo(AlisWSSoap), 'ALISKayitSorguTamamlandi', 'KAYITSORGU_ARR', '',
                                '[ArrayItemName="KayitSorguTamamla"]');
  { AlisWSSoap.ALISOrnekDurum }
  InvRegistry.RegisterMethodInfo(TypeInfo(AlisWSSoap), 'ALISOrnekDurum', '',
                                 '[ReturnName="ALISOrnekDurumResult"]', IS_OPTN);
  { AlisWSSoap.ALISTekSonucDurum }
  InvRegistry.RegisterMethodInfo(TypeInfo(AlisWSSoap), 'ALISTekSonucDurum', '',
                                 '[ReturnName="ALISTekSonucDurumResult"]', IS_OPTN);
  InvRegistry.RegisterParamInfo(TypeInfo(AlisWSSoap), 'ALISTekSonucDurum', 'ALISTekSonucDurumResult', '',
                                '[ArrayItemName="SonucDurum"]');
  { AlisWSSoap.ALISSonucDurum }
  InvRegistry.RegisterMethodInfo(TypeInfo(AlisWSSoap), 'ALISSonucDurum', '',
                                 '[ReturnName="ALISSonucDurumResult"]', IS_OPTN);
  InvRegistry.RegisterParamInfo(TypeInfo(AlisWSSoap), 'ALISSonucDurum', 'ALISSonucDurumResult', '',
                                '[ArrayItemName="SonucDurum"]');
  { AlisWSSoap.ALISIstemDurum }
  InvRegistry.RegisterMethodInfo(TypeInfo(AlisWSSoap), 'ALISIstemDurum', '',
                                 '[ReturnName="ALISIstemDurumResult"]', IS_OPTN);
  { AlisWSSoap.ALISSaglayiciSonucDurum }
  InvRegistry.RegisterMethodInfo(TypeInfo(AlisWSSoap), 'ALISSaglayiciSonucDurum', '',
                                 '[ReturnName="ALISSaglayiciSonucDurumResult"]', IS_OPTN);
  { AlisWSSoap.ALISDiyalizSonucDurum }
  InvRegistry.RegisterMethodInfo(TypeInfo(AlisWSSoap), 'ALISDiyalizSonucDurum', '',
                                 '[ReturnName="ALISDiyalizSonucDurumResult"]', IS_OPTN);
  { AlisWSSoap.ALISKayitSorgula }
  InvRegistry.RegisterMethodInfo(TypeInfo(AlisWSSoap), 'ALISKayitSorgula', '',
                                 '[ReturnName="ALISKayitSorgulaResult"]', IS_OPTN);
  { AlisWSSoap.ALISOrnekKayitSorgula }
  InvRegistry.RegisterMethodInfo(TypeInfo(AlisWSSoap), 'ALISOrnekKayitSorgula', '',
                                 '[ReturnName="ALISOrnekKayitSorgulaResult"]', IS_OPTN);
  { AlisWSSoap.ALISSonucYaz }
  InvRegistry.RegisterMethodInfo(TypeInfo(AlisWSSoap), 'ALISSonucYaz', '',
                                 '[ReturnName="ALISSonucYazResult"]', IS_OPTN);
  { AlisWSSoap.ALISSonucYazBasit }
  InvRegistry.RegisterMethodInfo(TypeInfo(AlisWSSoap), 'ALISSonucYazBasit', '',
                                 '[ReturnName="ALISSonucYazBasitResult"]');
  { AlisWSSoap.ALISIslemBildir }
  InvRegistry.RegisterMethodInfo(TypeInfo(AlisWSSoap), 'ALISIslemBildir', '',
                                 '[ReturnName="ALISIslemBildirResult"]', IS_OPTN);
  { AlisWSSoap.ALISDoktorBilgiSorgula }
  InvRegistry.RegisterMethodInfo(TypeInfo(AlisWSSoap), 'ALISDoktorBilgiSorgula', '',
                                 '[ReturnName="ALISDoktorBilgiSorgulaResult"]', IS_OPTN);
  { AlisWSSoap.ALISBarkodBilgi }
  InvRegistry.RegisterMethodInfo(TypeInfo(AlisWSSoap), 'ALISBarkodBilgi', '',
                                 '[ReturnName="ALISBarkodBilgiResult"]', IS_OPTN);
  { AlisWSSoap.ALISBarkodTanim }
  InvRegistry.RegisterMethodInfo(TypeInfo(AlisWSSoap), 'ALISBarkodTanim', '',
                                 '[ReturnName="ALISBarkodTanimResult"]', IS_OPTN);
  { AlisWSSoap.ALISEntegKodlari }
  InvRegistry.RegisterMethodInfo(TypeInfo(AlisWSSoap), 'ALISEntegKodlari', '',
                                 '[ReturnName="ALISEntegKodlariResult"]', IS_OPTN);
  { AlisWSSoap.ALISDoktorPanel }
  InvRegistry.RegisterMethodInfo(TypeInfo(AlisWSSoap), 'ALISDoktorPanel', '',
                                 '[ReturnName="ALISDoktorPanelResult"]', IS_OPTN);
  { AlisWSSoap.ALISTalesemiSonucDurum }
  InvRegistry.RegisterMethodInfo(TypeInfo(AlisWSSoap), 'ALISTalesemiSonucDurum', '',
                                 '[ReturnName="ALISTalesemiSonucDurumResult"]', IS_OPTN);
  { AlisWSSoap.ALISTalesemiKayitEkle }
  InvRegistry.RegisterMethodInfo(TypeInfo(AlisWSSoap), 'ALISTalesemiKayitEkle', '',
                                 '[ReturnName="ALISTalesemiKayitEkleResult"]', IS_OPTN);
  { AlisWSSoap.ALISOrnekDetayBilgiSorula }
  InvRegistry.RegisterMethodInfo(TypeInfo(AlisWSSoap), 'ALISOrnekDetayBilgiSorula', '',
                                 '[ReturnName="ALISOrnekDetayBilgiSorulaResult"]', IS_OPTN);
  InvRegistry.RegisterParamInfo(TypeInfo(AlisWSSoap), 'ALISOrnekDetayBilgiSorula', 'ALISOrnekDetayBilgiSorulaResult', '',
                                '[ArrayItemName="OrnekDetayBilgi"]');
  ...
  RemClassRegistry.RegisterXSClass(KonsultasyonTalepSonuc, 'http://tempuri.org/', 'KonsultasyonTalepSonuc');
  ...
  RemClassRegistry.RegisterExternalPropName(TypeInfo(IslemSonuc), 'TetkikArr', '[ArrayItemName="Tetkik"]');
  RemClassRegistry.RegisterExternalPropName(TypeInfo(IslemSonuc), 'BarkodInfoArr', '[ArrayItemName="BarkodInfo"]');
  ...
  RemClassRegistry.RegisterExternalPropName(TypeInfo(EntegRec), 'TetkikArr', '[ArrayItemName="Tetkik"]');
  ...
  RemClassRegistry.RegisterExternalPropName(TypeInfo(KULTURSONUC), 'ORGANIZMASONUCLIST', '[ArrayItemName="ORGANIZMASONUC"]');
  RemClassRegistry.RegisterXSClass(ORGANIZMASONUC, 'http://tempuri.org/', 'ORGANIZMASONUC');
  RemClassRegistry.RegisterExternalPropName(TypeInfo(ORGANIZMASONUC), 'ADTSONUCLIST', '[ArrayItemName="ADTSONUC"]');
  RemClassRegistry.RegisterXSInfo(TypeInfo(ArrayOfDisLabUrunIstem), 'http://tempuri.org/', 'ArrayOfDisLabUrunIstem');
  RemClassRegistry.RegisterXSClass(DisLabUrunIstemSonuc, 'http://tempuri.org/', 'DisLabUrunIstemSonuc');
  RemClassRegistry.RegisterExternalPropName(TypeInfo(DisLabUrunIstemSonuc), 'DisLabUrunIstemleri', '[ArrayItemName="DisLabUrunIstem"]');
  RemClassRegistry.RegisterXSClass(DisLabUrunIstem, 'http://tempuri.org/', 'DisLabUrunIstem');
  RemClassRegistry.RegisterXSInfo(TypeInfo(ArrayOfSonucDosya), 'http://tempuri.org/', 'ArrayOfSonucDosya');
  RemClassRegistry.RegisterXSClass(SonucDosyaResult, 'http://tempuri.org/', 'SonucDosyaResult');
  RemClassRegistry.RegisterExternalPropName(TypeInfo(SonucDosyaResult), 'Dosyalar', '[ArrayItemName="SonucDosya"]');
  RemClassRegistry.RegisterXSClass(MethodSonuc, 'http://tempuri.org/', 'MethodSonuc');
  RemClassRegistry.RegisterXSClass(SonucDosya, 'http://tempuri.org/', 'SonucDosya');
  ...
  RemClassRegistry.RegisterExternalPropName(TypeInfo(DiyalizSonucDurum), 'SonucDurumArr', '[ArrayItemName="SonucDurum"]');
  RemClassRegistry.RegisterXSClass(SaglayiciSonucDurum, 'http://tempuri.org/', 'SaglayiciSonucDurum');
  RemClassRegistry.RegisterExternalPropName(TypeInfo(SaglayiciSonucDurum), 'SonucDurumArr', '[ArrayItemName="SonucDurum"]');
  ...
  RemClassRegistry.RegisterExternalPropName(TypeInfo(OrnekKayitSorgulaDurum), 'KayitDurumArr', '[ArrayItemName="KayitDurum"]');
  RemClassRegistry.RegisterXSClass(KayitSorgulaDurum, 'http://tempuri.org/', 'KayitSorgulaDurum');
  RemClassRegistry.RegisterExternalPropName(TypeInfo(KayitSorgulaDurum), 'KayitDurumArr', '[ArrayItemName="KayitDurum"]');
  ...
  RemClassRegistry.RegisterExternalPropName(TypeInfo(EntegKodDurum), 'EntegKodArr', '[ArrayItemName="EntegKodlar"]');
  ...
  RemClassRegistry.RegisterExternalPropName(TypeInfo(PANEL), 'PanelTestArr', '[ArrayItemName="EntegKodlar"]');
  ...
  RemClassRegistry.RegisterExternalPropName(TypeInfo(PanelDurum), 'PanelArr', '[ArrayItemName="PANEL"]');
  RemClassRegistry.RegisterXSClass(Istem, 'http://tempuri.org/', 'Istem');
  RemClassRegistry.RegisterXSInfo(TypeInfo(ArrayOfSonuc), 'http://tempuri.org/', 'ArrayOfSonuc');
  RemClassRegistry.RegisterXSClass(SonucReq, 'http://tempuri.org/', 'SonucReq');
  RemClassRegistry.RegisterExternalPropName(TypeInfo(SonucReq), 'sonuclar', '[ArrayItemName="Sonuc"]');
  RemClassRegistry.RegisterXSClass(Sonuc, 'http://tempuri.org/', 'Sonuc');
  RemClassRegistry.RegisterXSInfo(TypeInfo(ArrayOfKonsultasyon), 'http://tempuri.org/', 'ArrayOfKonsultasyon');
  RemClassRegistry.RegisterXSClass(KonsultasyonSorguSonuc, 'http://tempuri.org/', 'KonsultasyonSorguSonuc');
  RemClassRegistry.RegisterExternalPropName(TypeInfo(KonsultasyonSorguSonuc), 'konsultasyonList', '[ArrayItemName="Konsultasyon"]');
  RemClassRegistry.RegisterXSInfo(TypeInfo(ArrayOfInt), 'http://tempuri.org/', 'ArrayOfInt');
  RemClassRegistry.RegisterXSClass(Konsultasyon, 'http://tempuri.org/', 'Konsultasyon');
  RemClassRegistry.RegisterXSInfo(TypeInfo(ArrayOfSonucYazDur), 'http://tempuri.org/', 'ArrayOfSonucYazDur');
  RemClassRegistry.RegisterXSClass(SonucRes, 'http://tempuri.org/', 'SonucRes');
  RemClassRegistry.RegisterExternalPropName(TypeInfo(SonucRes), 'sonucYazDurumlari', '[ArrayItemName="SonucYazDur"]');
  ...
  RemClassRegistry.RegisterExternalPropName(TypeInfo(IstemDurum), 'IstemArr', '[ArrayItemName="Istem"]');
  RemClassRegistry.RegisterXSInfo(TypeInfo(ArrayOfKayitSorguTamamla), 'http://tempuri.org/', 'ArrayOfKayitSorguTamamla');
  RemClassRegistry.RegisterXSClass(SonucYazDur, 'http://tempuri.org/', 'SonucYazDur');
  RemClassRegistry.RegisterXSClass(KayitSorguTamamlaDurum, 'http://tempuri.org/', 'KayitSorguTamamlaDurum');
  RemClassRegistry.RegisterExternalPropName(TypeInfo(KayitSorguTamamlaDurum), 'KAYIT_SORGU_ARR', '[ArrayItemName="KayitSorguTamamla"]');
