...
uses
  ...
  cxLookAndFeels, cxLookAndFeelPainters, cxContainer, cxEdit, cxTextEdit,
   IHastaEkle1, ITESTEKLE1,ISonucAl1, Winsoftservice,    cxMaskEdit, cxDropDownEdit, cxCalendar, Menus,XSBuiltIns,sGauge, sCheckBox,
 ...
 (* IMDLSHastaIslemleri1, LabIslemleri,Bridge_delphi1, AlisWs, AEN1, BirlabService,
    Duzen,data_model1,alisHizmetler,IMeddataLabService1,NoktaFormUnit, LABserviceERBIL,
    Intermedia,LabratuarIstek,LioasLab, TenayserviceV2, ErguvanCvp,
 *) ;
