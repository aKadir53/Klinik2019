object frmLabOrnekNoGiris: TfrmLabOrnekNoGiris
  ...
  object PopupMenu1: TPopupMenu
    ...
    object T2: TMenuItem
      ...
      object S20: TMenuItem
        Tag = 1
        Caption = 'Sonu'#231' Al TCKN'
        OnClick = S6Click
      end
    end
    object E4: TMenuItem
      ...
      object S19: TMenuItem
        Caption = 'Sonuclar'#305' Al'
        OnClick = S19Click
      end
      object B3: TMenuItem
        Caption = 'BarkodNo Olu'#351'tur'
        OnClick = B3Click
      end
    end
    ...
    object N18: TMenuItem
      ...
      object SonularAlTC1: TMenuItem
        Tag = 104
        Caption = 'Sonu'#231'lar'#305' Al (TC)'
        OnClick = S12Click
      end
    end
  ...
  object V4: THTTPRIO
    WSDLLocation = 'C:\Dializ2007_M3\TenayV4.wsdl'
    Service = 'TenayWebServiceV4'
    Port = 'TenayWebServiceSoapV4'
    HTTPWebNode.UseUTF8InHeader = True
    HTTPWebNode.InvokeOptions = [soIgnoreInvalidCerts, soAutoCheckAccessPointViaUDDI]
    HTTPWebNode.WebNodeOptions = []
