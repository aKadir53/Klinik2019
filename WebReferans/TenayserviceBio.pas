...
// WSDL     : http://95.70.143.123:1081/TenayService.asmx?wsdl
//  >Import : http://95.70.143.123:1081/TenayService.asmx?wsdl>0
// Encoding : utf-8
// Version  : 1.0
// (02.10.2015 11:11:07 - - $Rev: 25127 $)
// ************************************************************************ //

unit TenayserviceBio;
...
type
  ...
  // URL       : http://95.70.143.123:1081/TenayService.asmx
  // ************************************************************************ //
  TenayWebServiceSoapBio = interface(IInvokable)
...
function GetTenayWebServiceSoapBio(UseWSDL: Boolean=System.False; Addr: string=''; HTTPRIO: THTTPRIO = nil): TenayWebServiceSoapBio;


implementation
  uses SysUtils;

function GetTenayWebServiceSoapBio(UseWSDL: Boolean; Addr: string; HTTPRIO: THTTPRIO): TenayWebServiceSoapBio;
const
  defWSDL = 'http://95.70.143.123:1081/TenayService.asmx?wsdl';
  defURL  = 'http://95.70.143.123:1081/TenayService.asmx';
...
begin
  ...
  if HTTPRIO = nil then
    ...
    RIO := HTTPRIO;
  try
    Result := (RIO as TenayWebServiceSoapBio);
    if UseWSDL then
    begin
...
initialization
  InvRegistry.RegisterInterface(TypeInfo(TenayWebServiceSoapBio), 'http://tenay.com.tr/', 'utf-8');
  InvRegistry.RegisterDefaultSOAPAction(TypeInfo(TenayWebServiceSoapBio), 'http://tenay.com.tr/%operationName%');
  InvRegistry.RegisterInvokeOptions(TypeInfo(TenayWebServiceSoapBio), ioDocument);
  InvRegistry.RegisterInvokeOptions(TypeInfo(TenayWebServiceSoapBio), ioSOAP12);
