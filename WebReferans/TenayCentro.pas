       ...
       kayitTip := varToStr(gridAktif.DataController.GetValue(
        ...
        Then Begin
           ...
           _Tc_ := varToStr(gridAktif.DataController.GetValue(
             ...
             datalar.HTTP_XMLDosya_Name := 'C:\NoktaV3\Centro\SonucAl_' + dosyaNo + '_' + gelisNo + '.XML';
            ...
            if HTSOCvp.SonucKodu <> '0' // 0 kodunun iþlem baþarýlý oldu kodu oldðunu kontrol edelim.
            then
              txtLog.Lines.Add(HTSOCvp.SonucMesaji)
            else
