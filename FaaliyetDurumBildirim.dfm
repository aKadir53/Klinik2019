object frmFaaliyetDurumBildirim: TfrmFaaliyetDurumBildirim
  Left = 1
  Top = 1
  Caption = 'Faaliyet Durum Bildirimleri'
  ClientHeight = 469
  ClientWidth = 777
  Color = clBtnFace
  ...
  object cxGridKadir2: TcxGridKadir
    ...
    object gridRapor: TcxGridDBTableView
      ...
      object gridRapordurum: TcxGridDBColumn
        Caption = 'Bildirim'
        DataBinding.FieldName = 'durum'
        Width = 652
      end
      object gridRaporgozlemGrup: TcxGridDBColumn
        DataBinding.FieldName = 'gozlemGrup'
        Visible = False
      end
      object gridRaportanim: TcxGridDBColumn
        Caption = 'Faaliyet'
  ...
  object ADO_SahaGozetim: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'exec sp_SKS_Faaliyet_Durum_Raporu 2020')
    Left = 64
    Top = 256
  end
end
