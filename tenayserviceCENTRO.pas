...
// WSDL     : D:\Projeler\DELPHI\Diyaliz\Dializ2007_M3\tenayserviceCENTRO.WSDL
//  >Import : D:\Projeler\DELPHI\Diyaliz\Dializ2007_M3\tenayserviceCENTRO.WSDL>0
// Encoding : utf-8
// Version  : 1.0
// (26.09.2019 23:56:00 - - $Rev: 45757 $)
// ************************************************************************ //

unit tenayserviceCENTRO;
...
type
  ...
  Barkodlar            = class;                 { "http://tenay.com.tr/"[GblCplx] }
  LabBarkodlariGiris   = class;                 { "http://tenay.com.tr/"[GblCplx] }
  LabBarkodlariCevap   = class;                 { "http://tenay.com.tr/"[GblCplx] }
  ...
  OrderQueryHizmet     = class;                 { "http://tenay.com.tr/"[GblCplx] }
  ...
  ArrayOfBarkodlar = array of Barkodlar;        { "http://tenay.com.tr/"[GblCplx] }
  ...
  published
    ...
    property AlindigiTarih: TXSDate  read FAlindigiTarih write FAlindigiTarih;
  end;
  ...
  published
    ...
    property OrnekNo:      Int64              read FOrnekNo write FOrnekNo;
    property Tarih:        TXSDate        read FTarih write FTarih;
  ...
  // ************************************************************************ //
  // XML       : Barkodlar, global, <complexType>
  // Namespace : http://tenay.com.tr/
  // ************************************************************************ //
  Barkodlar = class(TRemotable)
  private
    FBarkod: Int64;
    FOrnekTurKodu: string;
    FOrnekTurKodu_Specified: boolean;
    FOrnekTurAdi: string;
    FOrnekTurAdi_Specified: boolean;
    FBaslik: string;
    FBaslik_Specified: boolean;
    procedure SetOrnekTurKodu(Index: Integer; const Astring: string);
    function  OrnekTurKodu_Specified(Index: Integer): boolean;
  ...
  published
    property Barkod:       Int64   read FBarkod write FBarkod;
    property OrnekTurKodu: string  Index (IS_OPTN) read FOrnekTurKodu write SetOrnekTurKodu stored OrnekTurKodu_Specified;
  ...
  // ************************************************************************ //
  // XML       : LabBarkodlariGiris, global, <complexType>
  // Namespace : http://tenay.com.tr/
  // ************************************************************************ //
  LabBarkodlariGiris = class(TRemotable)
  private
    FKurumReferans: string;
    FKurumReferans_Specified: boolean;
    FLabReferans: Int64;
    FKurumBilgileri: KurumBilgileri;
    FKurumBilgileri_Specified: boolean;
    FDoktorBilgileri: Doktor;
    FDoktorBilgileri_Specified: boolean;
    FOrnekNo: Int64;
    procedure SetKurumReferans(Index: Integer; const Astring: string);
    function  KurumReferans_Specified(Index: Integer): boolean;
    procedure SetKurumBilgileri(Index: Integer; const AKurumBilgileri: KurumBilgileri);
    function  KurumBilgileri_Specified(Index: Integer): boolean;
    procedure SetDoktorBilgileri(Index: Integer; const ADoktor: Doktor);
    function  DoktorBilgileri_Specified(Index: Integer): boolean;
  public
    destructor Destroy; override;
  published
    property KurumReferans:   string          Index (IS_OPTN) read FKurumReferans write SetKurumReferans stored KurumReferans_Specified;
    property LabReferans:     Int64           read FLabReferans write FLabReferans;
    property KurumBilgileri:  KurumBilgileri  Index (IS_OPTN) read FKurumBilgileri write SetKurumBilgileri stored KurumBilgileri_Specified;
    property DoktorBilgileri: Doktor          Index (IS_OPTN) read FDoktorBilgileri write SetDoktorBilgileri stored DoktorBilgileri_Specified;
    property OrnekNo:         Int64           read FOrnekNo write FOrnekNo;
  end;
  ...
  // ************************************************************************ //
  // XML       : LabBarkodlariCevap, global, <complexType>
  // Namespace : http://tenay.com.tr/
  // ************************************************************************ //
  LabBarkodlariCevap = class(TRemotable)
  private
    FSonucMesaji: string;
    FSonucMesaji_Specified: boolean;
    FKurumReferans: string;
    ...
    FBarkods: ArrayOfBarkodlar;
    FBarkods_Specified: boolean;
    FOrnekNo: Int64;
    procedure SetSonucMesaji(Index: Integer; const Astring: string);
    function  SonucMesaji_Specified(Index: Integer): boolean;
    procedure SetKurumReferans(Index: Integer; const Astring: string);
    ...
    procedure SetBarkods(Index: Integer; const AArrayOfBarkodlar: ArrayOfBarkodlar);
    function  Barkods_Specified(Index: Integer): boolean;
  public
    destructor Destroy; override;
  published
    property SonucMesaji:   string            Index (IS_OPTN) read FSonucMesaji write SetSonucMesaji stored SonucMesaji_Specified;
    ...
    property Barkods:       ArrayOfBarkodlar  Index (IS_OPTN) read FBarkods write SetBarkods stored Barkods_Specified;
    property OrnekNo:       Int64             read FOrnekNo write FOrnekNo;
  end;
  ...
  published
    ...
    property DogumTarihi: TXSDate  read FDogumTarihi write FDogumTarihi;
  ...
  // ************************************************************************ //
  // XML       : OrderQueryHizmet, global, <complexType>
  // Namespace : http://tenay.com.tr/
  // ************************************************************************ //
  OrderQueryHizmet = class(TRemotable)
  private
    FKurumBilgileri: KurumBilgileri;
    FKurumBilgileri_Specified: boolean;
    FDoktorBilgileri: Doktor;
  ...
  // style     : document
  // use       : literal
  // binding   : TenayWebServiceSoap12
  // service   : TenayWebService
  // port      : TenayWebServiceSoap12
  // URL       : http://176.236.24.68:8080/tenayservice.asmx
  // ************************************************************************ //
  TenayWebServiceSoapCENTRO = interface(IInvokable)
  ['{DE0C7615-FFA4-D4A3-EF4F-96183337FC76}']
    ...
    function  HastaSonucSorgulaReferansHizmet(const order: OrderQueryHizmet): HastaSorguCevapReferans; stdcall;
    ...
    function  LabBarkodlari(const giris: LabBarkodlariGiris): LabBarkodlariCevap; stdcall;
  end;

function GetTenayWebServiceSoap(UseWSDL: Boolean=System.False; Addr: string=''; HTTPRIO: THTTPRIO = nil): TenayWebServiceSoapCENTRO;


implementation
  uses SysUtils;

function GetTenayWebServiceSoap(UseWSDL: Boolean; Addr: string; HTTPRIO: THTTPRIO): TenayWebServiceSoapCENTRO;
const
  defWSDL = 'D:\Projeler\DELPHI\Diyaliz\Dializ2007_M3\tenayserviceCENTRO.WSDL';
  defURL  = 'http://176.236.24.68:8080/tenayservice.asmx';
  defSvc  = 'TenayWebService';
  defPrt  = 'TenayWebServiceSoap12';
var
  RIO: THTTPRIO;
begin
  Result := nil;
  ...
  if HTTPRIO = nil then
    ...
    RIO := HTTPRIO;
  try
    Result := (RIO as TenayWebServiceSoapCENTRO);
    if UseWSDL then
    begin
...
procedure Barkodlar.SetOrnekTurKodu(Index: Integer; const Astring: string);
begin
  FOrnekTurKodu := Astring;
  FOrnekTurKodu_Specified := True;
end;

function Barkodlar.OrnekTurKodu_Specified(Index: Integer): boolean;
begin
  Result := FOrnekTurKodu_Specified;
end;

procedure Barkodlar.SetOrnekTurAdi(Index: Integer; const Astring: string);
begin
  FOrnekTurAdi := Astring;
  FOrnekTurAdi_Specified := True;
end;

function Barkodlar.OrnekTurAdi_Specified(Index: Integer): boolean;
begin
  Result := FOrnekTurAdi_Specified;
end;

procedure Barkodlar.SetBaslik(Index: Integer; const Astring: string);
begin
  FBaslik := Astring;
  FBaslik_Specified := True;
end;

function Barkodlar.Baslik_Specified(Index: Integer): boolean;
begin
  Result := FBaslik_Specified;
end;

destructor LabBarkodlariGiris.Destroy;
begin
  SysUtils.FreeAndNil(FKurumBilgileri);
  SysUtils.FreeAndNil(FDoktorBilgileri);
  inherited Destroy;
...
procedure LabBarkodlariGiris.SetKurumReferans(Index: Integer; const Astring: string);
begin
  FKurumReferans := Astring;
  FKurumReferans_Specified := True;
end;

function LabBarkodlariGiris.KurumReferans_Specified(Index: Integer): boolean;
begin
  Result := FKurumReferans_Specified;
end;

procedure LabBarkodlariGiris.SetKurumBilgileri(Index: Integer; const AKurumBilgileri: KurumBilgileri);
begin
  FKurumBilgileri := AKurumBilgileri;
  FKurumBilgileri_Specified := True;
end;

function LabBarkodlariGiris.KurumBilgileri_Specified(Index: Integer): boolean;
begin
  Result := FKurumBilgileri_Specified;
end;

procedure LabBarkodlariGiris.SetDoktorBilgileri(Index: Integer; const ADoktor: Doktor);
begin
  FDoktorBilgileri := ADoktor;
  FDoktorBilgileri_Specified := True;
end;

function LabBarkodlariGiris.DoktorBilgileri_Specified(Index: Integer): boolean;
begin
  Result := FDoktorBilgileri_Specified;
end;

destructor LabBarkodlariCevap.Destroy;
var
  I: Integer;
begin
  for I := 0 to System.Length(FBarkods)-1 do
    SysUtils.FreeAndNil(FBarkods[I]);
  System.SetLength(FBarkods, 0);
  inherited Destroy;
end;

procedure LabBarkodlariCevap.SetSonucMesaji(Index: Integer; const Astring: string);
begin
  FSonucMesaji := Astring;
  FSonucMesaji_Specified := True;
end;

function LabBarkodlariCevap.SonucMesaji_Specified(Index: Integer): boolean;
begin
  Result := FSonucMesaji_Specified;
end;

procedure LabBarkodlariCevap.SetKurumReferans(Index: Integer; const Astring: string);
begin
  FKurumReferans := Astring;
  FKurumReferans_Specified := True;
end;

function LabBarkodlariCevap.KurumReferans_Specified(Index: Integer): boolean;
begin
  Result := FKurumReferans_Specified;
end;

procedure LabBarkodlariCevap.SetTCKimlik(Index: Integer; const Astring: string);
begin
  FTCKimlik := Astring;
  FTCKimlik_Specified := True;
end;

function LabBarkodlariCevap.TCKimlik_Specified(Index: Integer): boolean;
begin
  Result := FTCKimlik_Specified;
end;

procedure LabBarkodlariCevap.SetAdi(Index: Integer; const Astring: string);
begin
  FAdi := Astring;
  FAdi_Specified := True;
end;

function LabBarkodlariCevap.Adi_Specified(Index: Integer): boolean;
begin
  Result := FAdi_Specified;
end;

procedure LabBarkodlariCevap.SetSoyadi(Index: Integer; const Astring: string);
begin
  FSoyadi := Astring;
  FSoyadi_Specified := True;
end;

function LabBarkodlariCevap.Soyadi_Specified(Index: Integer): boolean;
begin
  Result := FSoyadi_Specified;
end;

procedure LabBarkodlariCevap.SetCinsiyeti(Index: Integer; const Astring: string);
begin
  FCinsiyeti := Astring;
  FCinsiyeti_Specified := True;
end;

function LabBarkodlariCevap.Cinsiyeti_Specified(Index: Integer): boolean;
begin
  Result := FCinsiyeti_Specified;
end;

procedure LabBarkodlariCevap.SetDogumTarihi(Index: Integer; const Astring: string);
begin
  FDogumTarihi := Astring;
  FDogumTarihi_Specified := True;
end;

function LabBarkodlariCevap.DogumTarihi_Specified(Index: Integer): boolean;
begin
  Result := FDogumTarihi_Specified;
end;

procedure LabBarkodlariCevap.SetBarkods(Index: Integer; const AArrayOfBarkodlar: ArrayOfBarkodlar);
begin
  FBarkods := AArrayOfBarkodlar;
  FBarkods_Specified := True;
end;

function LabBarkodlariCevap.Barkods_Specified(Index: Integer): boolean;
begin
  Result := FBarkods_Specified;
end;
...
destructor OrderQueryHizmet.Destroy;
begin
  SysUtils.FreeAndNil(FKurumBilgileri);
  SysUtils.FreeAndNil(FDoktorBilgileri);
  inherited Destroy;
...
procedure OrderQueryHizmet.SetKurumBilgileri(Index: Integer; const AKurumBilgileri: KurumBilgileri);
begin
  FKurumBilgileri := AKurumBilgileri;
  FKurumBilgileri_Specified := True;
end;

function OrderQueryHizmet.KurumBilgileri_Specified(Index: Integer): boolean;
begin
  Result := FKurumBilgileri_Specified;
end;

procedure OrderQueryHizmet.SetDoktorBilgileri(Index: Integer; const ADoktor: Doktor);
begin
  FDoktorBilgileri := ADoktor;
  FDoktorBilgileri_Specified := True;
end;

function OrderQueryHizmet.DoktorBilgileri_Specified(Index: Integer): boolean;
begin
  Result := FDoktorBilgileri_Specified;
end;

procedure OrderQueryHizmet.SetDosyaNo(Index: Integer; const Astring: string);
begin
  FDosyaNo := Astring;
  FDosyaNo_Specified := True;
end;

function OrderQueryHizmet.DosyaNo_Specified(Index: Integer): boolean;
begin
  Result := FDosyaNo_Specified;
end;

procedure OrderQueryHizmet.SetHizmetKodu(Index: Integer; const Astring: string);
begin
  FHizmetKodu := Astring;
  FHizmetKodu_Specified := True;
end;

function OrderQueryHizmet.HizmetKodu_Specified(Index: Integer): boolean;
begin
...
initialization
  { TenayWebServiceSoap }
  InvRegistry.RegisterInterface(TypeInfo(TenayWebServiceSoapCENTRO), 'http://tenay.com.tr/', 'utf-8');
  InvRegistry.RegisterDefaultSOAPAction(TypeInfo(TenayWebServiceSoapCENTRO), 'http://tenay.com.tr/%operationName%');
  InvRegistry.RegisterInvokeOptions(TypeInfo(TenayWebServiceSoapCENTRO), ioDocument);
  InvRegistry.RegisterInvokeOptions(TypeInfo(TenayWebServiceSoapCENTRO), ioSOAP12);
 (*
  ...
  { TenayWebServiceSoap.HastaSonucSorgulaReferansHizmet }
  InvRegistry.RegisterMethodInfo(TypeInfo(TenayWebServiceSoap), 'HastaSonucSorgulaReferansHizmet', '',
                                 '[ReturnName="HastaSonucSorgulaReferansHizmetResult"]', IS_OPTN);
...
*)
  ...
  RemClassRegistry.RegisterXSInfo(TypeInfo(ArrayOfBarkodlar), 'http://tenay.com.tr/', 'ArrayOfBarkodlar');
  ...
  RemClassRegistry.RegisterExternalPropName(TypeInfo(HizmetListesi), 'Liste', '[ArrayItemName="Detay"]');
  RemClassRegistry.RegisterXSClass(HastaListesi, 'http://tenay.com.tr/', 'HastaListesi');
  RemClassRegistry.RegisterExternalPropName(TypeInfo(HastaListesi), 'Liste', '[ArrayItemName="HastaDetay"]');
  RemClassRegistry.RegisterExternalPropName(TypeInfo(HastaListesi), 'HastaListe', '[ArrayItemName="HastaDetay"]');
  RemClassRegistry.RegisterXSClass(KurumListesi, 'http://tenay.com.tr/', 'KurumListesi');
  RemClassRegistry.RegisterExternalPropName(TypeInfo(KurumListesi), 'Liste', '[ArrayItemName="KurumDetay"]');
  ...
  RemClassRegistry.RegisterExternalPropName(TypeInfo(SonucKaydetSonuc), 'NormalDeger', '[ArrayItemName="SonucKaydetNormalDeger"]');
  RemClassRegistry.RegisterExternalPropName(TypeInfo(SonucKaydetSonuc), 'Dosya', '[ArrayItemName="SonucKaydetDosya"]');
  RemClassRegistry.RegisterXSClass(Barkodlar, 'http://tenay.com.tr/', 'Barkodlar');
  RemClassRegistry.RegisterXSClass(LabBarkodlariGiris, 'http://tenay.com.tr/', 'LabBarkodlariGiris');
  RemClassRegistry.RegisterXSClass(LabBarkodlariCevap, 'http://tenay.com.tr/', 'LabBarkodlariCevap');
  RemClassRegistry.RegisterExternalPropName(TypeInfo(LabBarkodlariCevap), 'Barkods', '[ArrayItemName="Barkodlar"]');
  RemClassRegistry.RegisterXSClass(TCSonuclariResult, 'http://tenay.com.tr/', 'TCSonuclariResult');
  RemClassRegistry.RegisterExternalPropName(TypeInfo(TCSonuclariResult), 'Sonuclar', '[ArrayItemName="OrnekSonuc"]');
  ...
  RemClassRegistry.RegisterExternalPropName(TypeInfo(SonucKaydetGiris), 'Sonuclar', '[ArrayItemName="SonucKaydetSonuc"]');
  ...
  RemClassRegistry.RegisterExternalPropName(TypeInfo(HastaTurListesi), 'Liste', '[ArrayItemName="TurDetay"]');
  ...
  RemClassRegistry.RegisterExternalPropName(TypeInfo(OrnekSonuc), 'Tetkikler', '[ArrayItemName="TetkikSonuc"]');
  ...
  RemClassRegistry.RegisterXSClass(OrderQueryHizmet, 'http://tenay.com.tr/', 'OrderQueryHizmet');
  ...
  RemClassRegistry.RegisterExternalPropName(TypeInfo(OrnekListesi), 'Ornekler', '[ArrayItemName="OrnekDetay"]');
  ...
  RemClassRegistry.RegisterExternalPropName(TypeInfo(HastaSorguCevapReferans), 'Tetkikler', '[ArrayItemName="TestSonuc"]');
  RemClassRegistry.RegisterXSClass(HastaSorguCevap, 'http://tenay.com.tr/', 'HastaSorguCevap');
  RemClassRegistry.RegisterExternalPropName(TypeInfo(HastaSorguCevap), 'Tetkikler', '[ArrayItemName="TetkikSonuc"]');
  ...
  RemClassRegistry.RegisterExternalPropName(TypeInfo(TetkikSonuc), 'NormalDegerler', '[ArrayItemName="TestNormalDeger"]');
  ...
  RemClassRegistry.RegisterExternalPropName(TypeInfo(TestSonuc), 'NormalDegerler', '[ArrayItemName="TestNormalDeger"]');
  ...
  RemClassRegistry.RegisterExternalPropName(TypeInfo(MikroIstek), 'Organizmalar', '[ArrayItemName="MikroOrganizma"]');
  RemClassRegistry.RegisterExternalPropName(TypeInfo(MikroIstek), 'Yorum', '[ArrayItemName="MikroYorum"]');
  RemClassRegistry.RegisterXSClass(MikroOrganizma, 'http://tenay.com.tr/', 'MikroOrganizma');
  RemClassRegistry.RegisterExternalPropName(TypeInfo(MikroOrganizma), 'Antibiyotikler', '[ArrayItemName="Antibiyotik"]');
  ...
  RemClassRegistry.RegisterExternalPropName(TypeInfo(TestEki), 'Data', '[ArrayItemName="string"]');
  RemClassRegistry.RegisterExternalPropName(TypeInfo(TestEki), 'Adi', '[ArrayItemName="string"]');
  RemClassRegistry.RegisterExternalPropName(TypeInfo(TestEki), 'Tur', '[ArrayItemName="DosyaTur"]');
  RemClassRegistry.RegisterExternalPropName(TypeInfo(TestEki), 'Url', '[ArrayItemName="string"]');
