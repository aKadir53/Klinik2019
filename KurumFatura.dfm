object frmKurumFatura: TfrmKurumFatura
  Left = 212
  Top = 137
  Align = alClient
  BorderStyle = bsNone
  Caption = 'frmKurumFatura'
  ClientHeight = 664
  ClientWidth = 1199
  Color = 13750737
      ...
      object cxGrid4: TcxGridKadir
        ...
        object FaturaList: TcxGridDBTableView
          ...
          object FaturaListGSSFaturaTeslimNo: TcxGridDBColumn
            DataBinding.FieldName = 'FaturaGuid'
            PropertiesClassName = 'TcxTextEditProperties'
            Properties.Alignment.Horz = taCenter
            Properties.Alignment.Vert = taVCenter
            HeaderAlignmentHorz = taCenter
          ...
          object FaturaListColumn6: TcxGridDBColumn
            DataBinding.FieldName = 'KurumTip'
            Visible = False
          end
          object FaturaListColumn7: TcxGridDBColumn
  ...
  object ADOQuery1: TADOQuery
    ConnectionString = 
      ...
      'r ID=Nokta;Initial Catalog=DYLZ_MELTEM;Data Source=185.198.72.18' +
      '5,16000'
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
      
        'exec sp_kurumFatura_m3 '#39'1004'#39','#39'20200701'#39','#39'20200831'#39','#39'1'#39','#39#39','#39#39','#39'0' +
        '00005'#39','#39#39)
    Left = 272
    Top = 384
  end
