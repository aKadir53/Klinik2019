object frmMaviKodBildirimListesi: TfrmMaviKodBildirimListesi
  Left = 1
  Top = 1
  Caption = 'Mavi Kod Bildirim Listesi'
  ClientHeight = 469
  ClientWidth = 777
  Color = clBtnFace
  ...
  object cxGridKadir2: TcxGridKadir
    ...
    object gridRaporlar: TcxGridDBTableView
      ...
      object gridRaporlarColumn1: TcxGridDBColumn
        Caption = 'Anonsu Yaptiran'
        DataBinding.FieldName = 'AnonsuYaptiran'
      ...
      object gridRaporlarColumn3: TcxGridDBColumn
        DataBinding.FieldName = 'KodVerilisSaati'
        PropertiesClassName = 'TcxTextEditProperties'
        Properties.Alignment.Horz = taCenter
        Properties.Alignment.Vert = taVCenter
        Width = 73
      end
      object gridRaporlarColumn4: TcxGridDBColumn
        DataBinding.FieldName = 'EkibininOlayYerineGelisSaati'
        PropertiesClassName = 'TcxTextEditProperties'
        Properties.Alignment.Horz = taCenter
        Properties.Alignment.Vert = taVCenter
      end
  ...
  object ADO_SahaGozetim: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select h.*,t.*,case when E.dosya is null then 0 else 1 end dosya' +
        'Var from MaviKodBildirim  t '
      
        '                               join HastaKart h on h.dosyaNo = t' +
        '.dosyaNo '
      
        '                              left join TaranmisEvraklar E on E.' +
        'ReferansID = t.id and E.ReferansTip = '#39'MaviKod'#39)
    Left = 64
    Top = 256
  end
end
