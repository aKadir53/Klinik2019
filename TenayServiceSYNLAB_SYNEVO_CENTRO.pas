...
// WSDL     : http://212.156.71.162:8094/TenayService.asmx?wsdl
//  >Import : http://212.156.71.162:8094/TenayService.asmx?wsdl>0
// Encoding : utf-8
// Version  : 1.0
// (08.10.2019 14:35:47 - - $Rev: 45757 $)
// ************************************************************************ //

unit TenayServiceSYNLAB_SYNEVO_CENTRO;
...
type
  ...
  // ************************************************************************ //
  TenayWebServiceSoapSSC = interface(IInvokable)
...
function GetTenayWebServiceSoapSYNLAB(UseWSDL: Boolean=System.False; Addr: string=''; HTTPRIO: THTTPRIO = nil): TenayWebServiceSoapSSC;


implementation
  uses SysUtils;

function GetTenayWebServiceSoapSYNLAB(UseWSDL: Boolean; Addr: string; HTTPRIO: THTTPRIO): TenayWebServiceSoapSSC;
const
...
begin
  ...
  if HTTPRIO = nil then
    ...
    RIO := HTTPRIO;
  try
    Result := (RIO as TenayWebServiceSoapSSC);
    if UseWSDL then
    begin
...
initialization
  { TenayWebServiceSoap }
  InvRegistry.RegisterInterface(TypeInfo(TenayWebServiceSoapSSC), 'http://tenay.com.tr/', 'utf-8');
  InvRegistry.RegisterDefaultSOAPAction(TypeInfo(TenayWebServiceSoapSSC), 'http://tenay.com.tr/%operationName%');
  InvRegistry.RegisterInvokeOptions(TypeInfo(TenayWebServiceSoapSSC), ioDocument);
  InvRegistry.RegisterInvokeOptions(TypeInfo(TenayWebServiceSoapSSC), ioSOAP12);
 (*
