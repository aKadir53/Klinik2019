...
// WSDL     : http://webservice.synevo.com.tr:8001/TenayService.asmx?wsdl
//  >Import : http://webservice.synevo.com.tr:8001/TenayService.asmx?wsdl>0
// Encoding : utf-8
// Version  : 1.0
// (22.10.2019 17:27:46 - - $Rev: 45757 $)
// ************************************************************************ //

unit TenayServiceSYNEVO;
...
type
  ...
  // URL       : http://webservice.synevo.com.tr:8001/TenayService.asmx
  // ************************************************************************ //
  TenayWebServiceSoapSYNEVO = interface(IInvokable)
...
function GetTenayWebServiceSoap(UseWSDL: Boolean=System.False; Addr: string=''; HTTPRIO: THTTPRIO = nil): TenayWebServiceSoapSYNEVO;


implementation
  uses SysUtils;

function GetTenayWebServiceSoap(UseWSDL: Boolean; Addr: string; HTTPRIO: THTTPRIO): TenayWebServiceSoapSYNEVO;
const
  defWSDL = 'http://webservice.synevo.com.tr:8001/TenayService.asmx?wsdl';
  defURL  = 'http://webservice.synevo.com.tr:8001/TenayService.asmx';
...
begin
  ...
  if HTTPRIO = nil then
    ...
    RIO := HTTPRIO;
  try
    Result := (RIO as TenayWebServiceSoapSYNEVO);
    if UseWSDL then
    begin
...
initialization
  { TenayWebServiceSoap }
  InvRegistry.RegisterInterface(TypeInfo(TenayWebServiceSoapSYNEVO), 'http://tenay.com.tr/', 'utf-8');
  InvRegistry.RegisterDefaultSOAPAction(TypeInfo(TenayWebServiceSoapSYNEVO), 'http://tenay.com.tr/%operationName%');
  InvRegistry.RegisterInvokeOptions(TypeInfo(TenayWebServiceSoapSYNEVO), ioDocument);
  InvRegistry.RegisterInvokeOptions(TypeInfo(TenayWebServiceSoapSYNEVO), ioSOAP12);
