...
type
  TfrmHastaRaporlari = class(TGirisForm)
...
var
   frmHastaRaporlari: TfrmHastaRaporlari;
...
procedure TfrmHastaRaporlari.AktifRaporYap;
var
  ado : TADOQuery;
  sql : string;
begin
...
procedure TfrmHastaRaporlari.RaporAra;
var
  sql : string;
begin
...
procedure TfrmHastaRaporlari.RaporuSistemdenSil;
var
...
procedure TfrmHastaRaporlari.RaporuYazdir;
var
...
procedure TfrmHastaRaporlari.RaporMeduladanSil;
var
  Rp : string;
begin
...
procedure TfrmHastaRaporlari.RaporMeduladanOku;
var
  Rp : string;
begin
     if datalar.RaporBilgisi.Turu = '10'
...
function TfrmHastaRaporlari.findMethod(dllHandle: Cardinal;  methodName: string): FARPROC;
begin
  Result := GetProcAddress(dllHandle, pchar(methodName));
end;

function TfrmHastaRaporlari.RaporImzalaGonder : string;
var
  imzala : TRaporImzala;
  dllHandle: Cardinal;
...
function TfrmHastaRaporlari.RaporIslemGonder(islem : string) : string;
var
  imzala : TRaporImzala;
  dllHandle: Cardinal;
  raporId,TesisKodu: integer;
...
procedure TfrmHastaRaporlari.RaporuMedulayaKaydet(islem : integer);
var
...
procedure TfrmHastaRaporlari.RaporuMedulayaKaydet;
var
...
procedure TfrmHastaRaporlari.YeniRapor;
var
  sql : string;
begin
...
function TfrmHastaRaporlari.RaporAciklamaEkle(RaporTakip,aciklama ,TakipformNo: string ; var msg : string) : string;
var
   RprAckEkle : EraporAciklamaEkleIstekDVO;
   RprAckEkleCvp : EraporAciklamaEkleCevapDVO;
   ack : EraporAciklamaDVO;
...
function TfrmHastaRaporlari.IlacRaporBasHekimOnayBekleyenLis : ArrayOf_105704153_1440052060_long;
var
...
function TfrmHastaRaporlari.IlacRaporBasHekimOnay(RaporNo , Tc : string) : string;
var
...
function TfrmHastaRaporlari.IlacRaporBasHekimOnayRed(RaporNo , Tc : string) : string;
var
...
procedure TfrmHastaRaporlari.IlacRaporsil(RaporNo : string);
var
...
procedure TfrmHastaRaporlari.RaporBul(RaporNo,RaporTarihi,verenTesis ,Tur , Durum  : string);
var
...
procedure TfrmHastaRaporlari.raporDuzenle;
var
  sql : string;
  Book : TBookmark;
begin
...
procedure TfrmHastaRaporlari.dogumOncesiCalisabilirRaporu;
var
...
procedure TfrmHastaRaporlari.IsGormezlikRaporu;
var
...
procedure TfrmHastaRaporlari.dogumRaporu;
var
   dogum : DogumRaporDVO;
...
procedure TfrmHastaRaporlari.analikRaporu;
var
...
procedure TfrmHastaRaporlari.B1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmHastaRaporlari.protezRaporu;
var
...
procedure TfrmHastaRaporlari.ilacRaporu;
var
   ilac : IlacRaporDVO;
...
procedure TfrmHastaRaporlari.ilacRaporuY;
var
...
procedure TfrmHastaRaporlari.maluliyetRaporu;
var
...
procedure TfrmHastaRaporlari.N1Click(Sender: TObject);
var
...
procedure TfrmHastaRaporlari.N5Click(Sender: TObject);
var
 Form : TGirisForm;
...
procedure TfrmHastaRaporlari.TedaviRaporu;
begin
...
procedure TfrmHastaRaporlari.IslemKaydet(data : TADOQuery ; var TedaviRapor : tedaviRaporDVO);
var
...
procedure TfrmHastaRaporlari.ListeRaporlarDblClick(Sender: TObject);
begin
  inherited;
  raporDuzenle;
end;

procedure TfrmHastaRaporlari.ListeRaporlarFocusedRecordChanged(
...
procedure TfrmHastaRaporlari.DoktorKaydet(raporID : string ; var _rapor : RaporDVO);
var
...
procedure TfrmHastaRaporlari.E1Click(Sender: TObject);
var
...
procedure TfrmHastaRaporlari.E2Click(Sender: TObject);
var
...
procedure TfrmHastaRaporlari.TeshisKaydet(data : TADOQuery);
var
...
procedure TfrmHastaRaporlari.TopPanelButonClick(Sender: TObject);
begin
//

   datalar.QuerySelect(RaporGrid.Dataset, 'select R.*,H.HASTAADI+'' ''+h.HASTASOYADI hasta,isnull(r.Onay,0) RaporOnay from Raporlar R join HastaKart h on R.dosyaNO = h.dosyaNo '  +
                                          ' where R.raporTarihi between ' + txtTopPanelTarih1.GetSQLValue +
                                          ' and ' + txtTopPanelTarih2.GetSQLValue + ' and Turu = ''10'' ' +
                                          ' and h.sirketKod = ' + QuotedStr(datalar.AktifSirket)
                                          );

end;

procedure TfrmHastaRaporlari.TaniKaydet(raporID : string ; var _rapor : RaporDVO);
var
   Tani : TaniBilgisiDVO;
...
procedure TfrmHastaRaporlari.HaksahibiKaydet(don : integer);
var
...
procedure TfrmHastaRaporlari.Haksahibinull;
var
   HaksahibiBil : HakSahibiBilgisiDVO;
...
procedure TfrmHastaRaporlari.RAPORBILGISI(data : TADOQuery; var TedaviRapor : tedaviRaporDVO);
var
 AciklamaList : Array_Of_eraporAciklamaDVO;
 _Rapor : RaporDVO;
...
procedure TfrmHastaRaporlari.IlacTeshisKaydet(data : TADOQuery);
var
...
procedure TfrmHastaRaporlari.IlacTeshisKaydetY(data : TADOQuery);
var
...
function TfrmHastaRaporlari.Init(Sender: TObject): Boolean;
begin
   Result := False;
   Result := True;
end;

function TfrmHastaRaporlari.TaniKaydetIlacTeshisIlac(_tanilar_ : string ;  data : TADOQuery) : Array_Of_TaniDVO;
var
...
function TfrmHastaRaporlari.TaniKaydetIlacTeshisY(_tanilar_ : string ;  data : TADOQuery) : ArrayOf_105704153_699425500_nillable_TaniDVO;
var
   Tani : TaniDVO;
...
procedure TfrmHastaRaporlari.RaporKaydet(dosyaNo , raporNo , turu ,Tip : string);
var
   sql : string;
...
procedure TfrmHastaRaporlari.Raporlar(dosyaNo ,gelisNo : string);
var
   sql : string;
begin
...
procedure TfrmHastaRaporlari.btnVazgecClick(Sender: TObject);
begin
...
procedure TfrmHastaRaporlari.FormClose(Sender: TObject;
...
procedure TfrmHastaRaporlari.FormCreate(Sender: TObject);
begin
  //datalar.Login;
...
procedure TfrmHastaRaporlari.DBGridEh1ColExit(Sender: TObject);
begin
(*
...
procedure TfrmHastaRaporlari.btnYazdirClick(Sender: TObject);
var
   sql , dosyaNo , raporNo : string;
...
procedure TfrmHastaRaporlari.ADO_DOKTORLARNewRecord(DataSet: TDataSet);
begin
...
procedure TfrmHastaRaporlari.ADO_RAPORDETAYNewRecord(DataSet: TDataSet);
begin
 (*
...
procedure TfrmHastaRaporlari.cxDBButtonEdit1PropertiesButtonClick(
...
procedure TfrmHastaRaporlari.cxDBButtonEdit2PropertiesButtonClick(
  Sender: TObject; AButtonIndex: Integer);
begin
 (*
...
procedure TfrmHastaRaporlari.cxDBButtonEdit3PropertiesButtonClick(
  Sender: TObject; AButtonIndex: Integer);
begin
      (*
...
procedure TfrmHastaRaporlari.cxDBComboBox1PropertiesChange(Sender: TObject);
begin
...
procedure TfrmHastaRaporlari.cxRadioGroup1PropertiesChange(Sender: TObject);
begin
  inherited;
//  ADO_RAPORLAR.Filter := 'turu = ' + cxRadioGroup1.EditingValue;
end;

procedure TfrmHastaRaporlari.txttedaviRaporTuruPropertiesChange(
  Sender: TObject);
begin
(*
...
procedure TfrmHastaRaporlari.ftrVucutBolgePropertiesChange(Sender: TObject);
begin
  //  ADO_RAPORLAR.FieldByName('ftrVucutBolgesiKodu').AsInteger :=
  //  strtoint(trim(copy(ftrVucutBolge.Text,1,2)));
end;

procedure TfrmHastaRaporlari.txtVerenTesisKoduPropertiesButtonClick(
  Sender: TObject; AButtonIndex: Integer);
begin
     (*
...
procedure TfrmHastaRaporlari.sBitBtn3Click(Sender: TObject);
begin
//  ADO_RAPORLAR.Edit;
end;

procedure TfrmHastaRaporlari.btnKayitClick(Sender: TObject);
begin
 // ADO_RAPORLAR.Edit;
...
procedure TfrmHastaRaporlari.sBitBtn5Click(Sender: TObject);
begin
 // ADO_RAPORLAR.Cancel;
end;

procedure TfrmHastaRaporlari.Rapor__BeforeExecute(const MethodName: String;
  var SOAPRequest: WideString);
begin
 //  txtXML.Clear;
...
procedure TfrmHastaRaporlari.SablonKaydet;
var
...
procedure TfrmHastaRaporlari.cxButtonTESHISClick(Sender: TObject);
begin
  (*
   try
      Application.CreateForm(TfrmTeshisListesi, frmTeshisListesi);
...
procedure TfrmHastaRaporlari.cxButtonICDClick(Sender: TObject);
var
  t : string;
...
procedure TfrmHastaRaporlari.cxButtonETKENClick(Sender: TObject);
begin
  (*
     try
...
procedure TfrmHastaRaporlari.cxButtonSUTKURALClick(Sender: TObject);
var
  kuralSec : string;
begin
...
procedure TfrmHastaRaporlari.ADO_ILACTESHISLERNewRecord(DataSet: TDataSet);
begin
...
procedure TfrmHastaRaporlari.ADO_RAPORLARAfterScroll(DataSet: TDataSet);
begin
    (*
       if trim(ADO_RAPORLAR.FieldByName('turu').AsString) = '1'
       Then begin
...
function TfrmHastaRaporlari.RaporEtkinMaddeler(m , sira: string) : ArrayOfEraporEtkinMaddeDVO;
var
   EtkinMadde : EraporEtkinMaddeDVO;
   EtkinMaddeler : ArrayOfEraporEtkinMaddeDVO;
   x , dizi: integer;
...
procedure TfrmHastaRaporlari.btnDuzeltClick(Sender: TObject);
var
...
procedure TfrmHastaRaporlari.cxButtonDoktorlarClick(Sender: TObject);
var
  t : string;
  List : ArrayListeSecimler;
begin
...
procedure TfrmHastaRaporlari.btnDiyabetClick(Sender: TObject);
var
  _ok_ : integer;
begin
  _ok_ := 0;
